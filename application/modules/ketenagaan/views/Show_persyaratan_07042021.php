 ...
 <div class="row">
	...
	?>     
            ...
            <table id="table-matkul" class="table table-bordered table-hover">
              ...
              <?php var_dump($jad_usulan); ?>
            <?php if($jabatan_usulan_no=='14' || $jabatan_usulan_no=='15') {?>
              <tr>
                <td class="text-center">19</td>
                <td>Pernah mendapatkan hibah penelitian kompetitif/penugasan tingkat daerah/nasional/kementerian/internasional/korporasi,atau kompetitif internal Perguruan Tinggi (sebagai ketua, kecuali penelitian Program tesis/disertasi)<code>**</code></td>
                <?php if(isset($ceklis->hibah_penelitian)){ ?>
                <td class="text-center" style="width: 50px;">
                <a href="<?= base_url()?>assets/download_syarat/<?= $ceklis->hibah_penelitian ?>" target="_blank" class="btn btn-xs btn-info">
                  <i class="fa fa-search"></i>
                </a>
                </td>
                <td class="text-center" style="width: 50px;">
                <?php if($role=='3' && $usulan_status=='1'){?><a href="<?= base_url()?>usulan/usulan/hapus_syarat/<?= $ceklis->hibah_penelitian ?>/<?= $ceklis->usulan_no ?>/hibah_penelitian" class="btn btn-xs btn-danger tombol-hapus">
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                <?php if($role=='3' && $usulan_status=='1'){?>  <a href="#uploadModal" data-toggle="modal" data-nama="hibah_penelitian" data-judul=" Hibah Penelitian" class="btn btn-xs btn-warning"><i class="fa fa-upload"></i></a><?php}else{ ?>
              ...
              <tr>
                ...
                <td>Pernah membimbing/membantu membimbing Program doktor<code>**</code></td>
                <?php if(isset($ceklis->pemb_doktor)){ ?>
                <td class="text-center" style="width: 50px;">
                <a href="<?= base_url()?>assets/download_syarat/<?= $ceklis->pemb_doktor ?>" target="_blank" class="btn btn-xs btn-info">
                  <i class="fa fa-search"></i>
                </a>
                </td>
                <td class="text-center" style="width: 50px;">
                <?php if($role=='3' && $usulan_status=='1'){?><a href="<?= base_url()?>usulan/usulan/hapus_syarat/<?= $ceklis->pemb_doktor ?>/<?= $ceklis->usulan_no ?>/pemb_doktor" class="btn btn-xs btn-danger tombol-hapus">
					<i class="fa fa-trash"></i></a> <?php}else{ ?>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                <?php if($role=='3' && $usulan_status=='1'){?>  <a href="#uploadModal" data-toggle="modal" data-nama="pemb_doktor" data-judul=" membimbing/membantu membimbing Program doktor" class="btn btn-xs btn-warning"><i class="fa fa-upload"></i></a><?php}else{ ?>
              ...
              <tr>
                ...
                <td>Pernah menguji sekurang-kurangnya tiga mahasiswa program doktor (baik di perguruan tinggi sendiri maupun perguruan tinggi lain<code>**</code></td>
                <?php if(isset($ceklis->penguji_doktor)){ ?>
                <td class="text-center" style="width: 50px;">
                <a href="<?= base_url()?>assets/download_syarat/<?= $ceklis->penguji_doktor ?>" target="_blank" class="btn btn-xs btn-info">
                  <i class="fa fa-search"></i>
                </a>
                </td>
                <td class="text-center" style="width: 50px;">
                <?php if($role=='3' && $usulan_status=='1'){?><a href="<?= base_url()?>usulan/usulan/hapus_syarat/<?= $ceklis->penguji_doktor ?>/<?= $ceklis->usulan_no ?>/penguji_doktor" class="btn btn-xs btn-danger tombol-hapus">
					<i class="fa fa-trash"></i></a> <?php}else{ ?>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                <?php if($role=='3' && $usulan_status=='1'){?>  <a href="#uploadModal" data-toggle="modal" data-nama="penguji_doktor" data-judul=" menguji sekurang-kurangnya tiga mahasiswa program doktor (baik di perguruan tinggi sendiri maupun perguruan tinggi lain" class="btn btn-xs btn-warning"><i class="fa fa-upload"></i></a><?php}else{ ?>
               ...
               <tr>
                ...
                <td>Sebagai reviewer sekurang-kurangnya pada 2 (dua) jurnal internasional bereputasi yang berbeda<code>**</code></td>
                <?php if(isset($ceklis->reviewer_inter)){ ?>
                <td class="text-center" style="width: 50px;">
                <a href="<?= base_url()?>assets/download_syarat/<?= $ceklis->reviewer_inter ?>" target="_blank" class="btn btn-xs btn-info">
                  <i class="fa fa-search"></i>
                </a>
                </td>
                <td class="text-center" style="width: 50px;">
                <?php if($role=='3' && $usulan_status=='1'){?><a href="<?= base_url()?>usulan/usulan/hapus_syarat/<?= $ceklis->reviewer_inter ?>/<?= $ceklis->usulan_no ?>/reviewer_inter" class="btn btn-xs btn-danger tombol-hapus">
					<i class="fa fa-trash"></i></a> <?php}else{ ?>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                <?php if($role=='3' && $usulan_status=='1'){?>  <a href="#uploadModal" data-toggle="modal" data-nama="reviewer_inter" data-judul=" reviewer sekurang-kurangnya pada 2 (dua) jurnal internasional bereputasi yang berbeda" class="btn btn-xs btn-warning"><i class="fa fa-upload"></i></a><?php}else{ ?>
               ...
               <hr>
           <code> ** Diwajibkan untuk Dosen mengupload salah satu persyaratan pada nomer 19, 20, 21, 22</code>
              <?php } ?>
