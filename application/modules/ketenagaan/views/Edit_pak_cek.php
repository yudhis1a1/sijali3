...
?>       
                 <form  method="post" action="<?= base_url()?>ketenagaan/ketenagaan/updatePak/<?php echo $no; ?>" role="form" enctype="multipart/form-data">
                  ...
                  <tbody>
                    ...
                    <tr  >
                     <center>
                       <b style="font-weight: bold;">
                        PENETAPAN ANGKA KREDIT  <?php if($resume->tmt_no){?> <?php }else{?><a href="<?php echo base_url('ketenagaan/ketenagaan/noBaru/'. $no); ?>"><button type="button"  class="btn btn-default pull-right">Nomor PAK</button></a><?php } ?>
                        ...
                        <input type="hidden" name="no_dosen" value="<?=$resume->no_dosen?> "  required="required"> 
                        ...
                        <?php } else { ?>
                          <br><b>Masa Penilaian : Tanggal <input type="text" name="masa_penilaian_awal" value="<?=$masa_awal;?> " style="width: 150px;" readonly> s/d 
                        <input type="text"  name="masa_penilaian_akhir" value="<?=$tgl_akhir;?> " style="width: 150px;"  readonly>  </b>
                        <input type="hidden" name="masa_penilaian_awal" value="<?=$masa_awal;?>" >
                        <input type="hidden"  name="masa_penilaian_akhir" value="<?=$tgl_penilaian_akhir;?> ">
                        <?php }?>
                         </b>
                        </center>
                   ...
                   $jabatan_rwy_pak = $this->db->where(['no_usulan'=> $no])->from("rwy_pak")->count_all_results();
                      ...
                      <?php if(!empty($jab_rwy_pak->gelar_depan)){ ?>
                        <td colspan="5" > <input type="text" name="g_depan" value="<?=$jab_rwy_pak->gelar_depan?>" style="width: 100px;" >
                    ...
                    <tr >
                      ...
                      <?php if(!empty($resume->gelar_depan)){ ?>
                        <td colspan="5" > <input type="text" name="g_depan" value="<?=$g_depan?>" style="width: 100px;" >
                    ...
                    <tr>
                      ...
                      <?php
                          ...
                          /* $resume_didik=$this->db->query("SELECT a.*,MAX(a.`created_at`) FROM 
                          `rwy_pend_pak` a WHERE a.`no_dosen`='$resume->dosen_no' 
                      ...
                      /*       $resume_didik=$this->db->query("SELECT 
                          b.`no_dosen`,							
							...
							c.`nama_jenjang`,							
                             ...
                             WHERE a.`no`='$resume->dosen_no' AND b.`id_jenjang_pak` >'22' ORDER BY b.`id_jenjang_pak`,b.`thn_lulus` ASC")->result();  */
                             ...
                             WHERE a.no_dosen= '$resume->dosen_no' AND a.`id_jenjang_pak` > '22' ORDER BY a.jenj_pak,a.thn_lulus ASC")->result();
                 ...
                 WHERE a.`no` = '$resume->no_dosen'
                  ...
                  $gol_next=$resume_golongan->golongan_kode+1;      
                    ...
                    WHERE b.`no_dosen`='$resume->no_dosen' AND b.`no_usulan`='$no'");
                    ...
                    <tr>
                      ...
                      ?>
  																</select> /  <input type="text" class="date-picker"  name="golongan_tgl"  value="<?=$gol_pak->golongan_tgl_pak?>" style="width: 200px;"  required="required"></td>  
                    ...
                    <?php
                      ...
                      ?>
  																</select> / <input type="text" class="date-picker"  name="golongan_tgl"  value="<?=$resume_golongan->golongan_tgl?>" style="width: 200px;"  required="required"></td>  
            ...
            <?php }?>
                    <tr>
                      ...
                      <td colspan="5"><input type="text" name="fakultas"  value="<?=$resume->fakultas?>" style="width: 250px;"  required="required"> / <?php if($jab_rwy_pak->prodi_homebase_pak){ echo $jab_rwy_pak->prodi_homebase_pak; } else { echo $resume->nama_prodi.' '.$jenjang_prodi->nama_jenjang;}?></td>
                      <?php } else {  ?>
                        <td colspan="3"> Program Studi</td>                      
                      <td colspan="5"> <?php if($jab_rwy_pak->prodi_homebase_pak){ echo $jab_rwy_pak->prodi_homebase_pak; } else { echo $resume->nama_prodi.' '.$jenjang_prodi->nama_jenjang;}?></td>
                      <?php } ?>                     
                      <input type="hidden" name="prodi_homebase"  value="<?=$resume->nama_prodi?> <?=$jenjang_prodi->nama_jenjang?>" style="width: 250px;">
                    ...
                    if ($masa_kerja_baru->bulan < 0) {
                     ...
                     if( $jabatan_rwy_pak->baru_tahun_pak) {
                      ?>
                    <tr>
                      <td class="text-center">11.</td>
                  
                      <td colspan="2">Masa Kerja Golongan</td>
                      <td  width='85'>a. Lama</td>
                     
                      <td colspan="5"><input type="number" name="lama_th_pak"  value="<?=$jab_rwy_pak->lama_tahun_pak?>" style="width: 50px;" min="0"  required="required"> Tahun 
                      <input type="number" name="lama_bln_pak"  value="<?=$jab_rwy_pak->lama_bulan_pak?>" style="width: 50px;" min="0"  required="required"> Bulan</td>
                    ...
                    <tr>
                      ...
                      <input type="number" name="baru_bln_pak"  value="<?=$jab_rwy_pak->baru_bulan_pak?>" style="width: 50px;" min="0"  required="required"> Bulan</td>
                    </tr>
                     <?php } else { ?>
                      <tr>
                      <td class="text-center">11.</td>
                      ...
                      <td colspan="5"><input type="number" name="lama_th_pak"  value="<?=$lama_tahun?>" style="width: 50px;" min="0"   required="required"> Tahun 
                      <input type="number" name="lama_bln_pak"  value="<?=$lama_bulan?>" style="width: 50px;" min="0"  required="required"> Bulan</td>
                    ...
                    <tr>
                      ...
                      <td colspan="2"></td>                      
                      <td width='80'>b. Baru</td>
                      <td colspan="5"><input type="number" name="baru_th_pak"  value="<?=$baru_tahun?>" style="width: 50px;" min="0"  required="required"> Tahun 
                      <input type="number" name="baru_bln_pak"  value="<?=$baru_bulan?>" style="width: 50px;" min="0"  required="required"> Bulan</td>
                    </tr>
                     <?php }?>
                    <tr>
...
if($resume->jabatan_no<>31)
{
	$r_ak_lama=$this->db->query("SELECT
				...
				FROM
				  ...
				  `jabatans` AS b,
				  `jenjangs` AS c
				WHERE a.`dosen_no`= '$resume->no_dosen'
				  AND a.`jabatan_no`=b.`kode`
...
$k5=$r_persen->pd*0.01*$kebutuhan;
     ...
     if(isset($kat_1->kum_usulan_baru)){
      ...
      $kum_pendidikan='0.00';
       ...
       $k_lama=$r_persen->pa*0.01*$dasar_kum_lama;
       $k1_lama=$r_persen->pb*0.01*$dasar_kum_lama;
       $k4_lama=$r_persen->pc*0.01*$dasar_kum_lama;
       $k5_lama=$r_persen->pd*0.01*$dasar_kum_lama;
...
?>
                    ...
                    <tr >
                      ...
                      <td class="text-right"><?=$jml_kum_didik?></td>
                   ...
                   <p>Yth. Sdr. <?=$g_depan?> <?=ucwords(strtolower($resume->nama))?>, <?=$resume->gelar_belakang?>
                     ...
                     <?php } ?>
                      ...
                      <p>   Ditetapkan di Jakarta
                        <br>Pada Tanggal :  <input type="text"   name="pak_tgl" value="<?=$tgl_akhir;?> " style="width: 150px;" readonly> </p>
                      <hr class="h"/>
                    ...
                    <?php
                      ...
                      <input type="hidden" name="tgl_tmt"  value="<?=$tgltmt?>" >
                      <input type="hidden" name="pak_tgl"  value="<?=$$tgl_penilaian_akhir?>" >
