...
<div class="card-body">
	...
	<?php } ?>
	<?php if ($data_dasar->usulan_status_id == '3'  || $data_dasar->usulan_status_id == '6') {
	?>
		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item"> <a class="nav-link" data-toggle="tab" id="nav_doc" href="#doc" role="tab"><span class="hidden-sm-up"><i class="ti-bookmark-alt "></i></span> <span class="hidden-xs-down">File PAK</span></a> </li>
