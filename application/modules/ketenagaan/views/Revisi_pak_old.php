            ...
            <tbody>
              ...
              b.`no_dosen`,							
               ...
               c.jenj_pak				                  
                     ...
                     WHERE a.`no`='$resume->dosen_no' AND b.`id_jenjang_pak` >'22' ORDER BY c.jenj_pak,b.`thn_lulus` ASC")->result(); */
              ...
              <?php } else { ?>
                ...
                <tr>
                  ...
                  <?php
                  $homebase = $this->db->query("  SELECT a.*, b.`nama_prodi` FROM dosens a LEFT JOIN prodis b ON a.`bidang_ilmu_kode`=b.`kode` WHERE a.`no`='$resume->nodos'")->row();
                ...
                <?php if ($resume->jabatan_no == '31') {
                  ...
                  if ($masa_kerja_lama->bulan < 0) {
                    ...
                    $lama_bulan = $masa_kerja_lama->bulan+ 1;
                  }
                  if ($masa_kerja_lama->bulan >= 11) {
                    $lama_bulan = '0';
                    $lama_tahun = $masa_kerja_lama->tahun+1;
                  } */
                  ...
                  <td colspan="10">
                    ...
                    <?php } else { ?>
                      <p> Dapat Dinaikan Dalam Jabatan Akademik Dosen : <b style="font-weight: bold;"><?= $resume_jab_usulan->nama_jabatans ?> <?= $resume_jab_usulan->kum ?> KUM</b>, Terhitung Mulai Tanggal <b style="font-weight: bold;"><?= $tgl_terhitung; ?></b>,
                        dengan lebihan angka kredit bidang Penelitian <?php if ($kum_penelitian > 0.0) { ?> <?= $kum_penelitian ?> KUM
          ...
          <div class="table-responsive">
            <table width="100%">
              <tr>
                ...
                <form method="post" action="<?= base_url() ?>ketenagaan/ketenagaan/revisi_TglPak/<?php echo $no; ?>" role="form" enctype="multipart/form-data">
                <td colspan="4" style="vertical-align: top; border-left: none; border-right: none; ">
                  ...
                  <hr class="h" />
                  <?php if ((date("m", strtotime($tgltmt)) > 5)  && (date("Y", strtotime($tgltmt)) >= 2021)) { ?>
                    <p> Kementerian Pendidikan, Kebudayaan, <br> Riset, dan Teknologi
                    <?php } else { ?>
                ...
                if ($resume->prodi_jen == '22') { ?>
                  ...
                  <td colspan="5" style="border-left: none; border-right: none; border-bottom: none;">
                    <p> <br> Tembusan disampaikan kepada :
                      <?php if ((date("m", strtotime($tgltmt)) > 5)  && (date("Y", strtotime($tgltmt)) >= 2021)) { ?>
                        <br> 1. Dirjen Dikti Kemendikbudristek;
