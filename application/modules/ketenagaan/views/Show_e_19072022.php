										...
										<table class="table color-table info-table table-bordered">
											...
											<tbody>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0005/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0006/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0007/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0008/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0009/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0010/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
												...
												<tr class="text-center" bgcolor="<?= $warna ?>">
													...
													<td style="vertical-align: middle;">
														<a href="<?= base_url() ?>ketenagaan/Usulan_dupak_e/dupak/E0011/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
													</td>
												</tr>
