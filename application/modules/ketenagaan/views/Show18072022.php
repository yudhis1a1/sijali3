...
<div class="card-body">
	<?php
	if ($data_dasar->usulan_status_id == '3' || $data_dasar->usulan_status_id == '12' || $data_dasar->usulan_status_id == '13' || $data_dasar->usulan_status_id == '14' || $data_dasar->usulan_status_id == '15' || $data_dasar->usulan_status_id == '6' || $data_dasar->usulan_status_id == '7' || $data_dasar->usulan_status_id == '9' || $data_dasar->usulan_status_id == '11') {
	?>
					...
					<div class="form-group">
						...
						<select name="status_usulan" class="form-control select" id="status_usulan" data-placeholder="Click to Choose..." required>
							...
							?>
								...
								<option <?php if ($data_dasar->usulan_status_id == '14') echo 'selected'; ?> value="14">Proses Validasi PAK</option>
							<?php
							}
