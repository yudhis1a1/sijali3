	...
	<table class="cust-table cust-table-bordered">
		...
		<tbody>
			...
			<tr bgcolor="<?= $warna ?>">
				...
				<td><a href="<?= base_url() ?>ketenagaan/usulan_dupak_b/dupak/B0002/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20" target='_blank'><i class="fa fa-search"></i></a></td>
			</tr>
			<?php
			...
			<tr bgcolor="<?= $warna ?>">
				...
				<td><a href="<?= base_url() ?>ketenagaan/usulan_dupak_b/dupak/B0004/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20" target='_blank'><i class="fa fa-search"></i></a></td>
			</tr>
			<?php
