...
AND a.id_sdm = '$resume->dosen_no' GROUP BY a.`id_rwy_didik_formal` ORDER BY a.`thn_lulus` ASC")->result();
                ...
                <tr>
                  ...
                  <?php
                  if ($tmt->usulan_no) {  ?>
                    <td colspan="5"><input type="number" name="lama_th_pak" value="<?= $tmt->tmt_tahun ?>" style="width: 50px;" min="0" required="required"> Tahun
                      <input type="number" name="lama_bln_pak" value="<?= $tmt->tmt_bulan ?>" style="width: 50px;" min="0" required="required"> Bulan
                    </td>
                  ...
                  <?php } else { ?>
                    <td colspan="5"><input type="number" name="lama_th_pak" value="0" style="width: 50px;" min="0" required="required"> Tahun
                      <input type="number" name="lama_bln_pak" value="0" style="width: 50px;" min="0" required="required"> Bulan
                    </td>
                  <?php } ?>
                </tr>
                <?php
                ...
                <?php } else { ?>
                  <tr>
                    ...
                    <td colspan="5"><input type="number" name="baru_th_pak" value="<?= $baru_tahun ?>" style="width: 50px;" min="0" required="required"> Tahun
                      <input type="number" name="baru_bln_pak" value="<?= $baru_bulan ?>" style="width: 50px;" min="0" required="required"> Bulan
                    </td>
                  </tr>
                <?php } ?>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="4" style="vertical-align: top; border-left: none; border-right: none; font-weight: bold; font-family: Calibri; font-size:16px;">
                    <p> Ditetapkan di Jakarta
                      <?php if ($resume->tgl_revisi_pak) {
                        $tgl_revisi = gfDateStandart($resume->tgl_revisi_pak);
                      ?>
                        <br>Pada Tanggal : <input type="text" name="pak_tgl" value="<?= $tgl_revisi; ?> " style="width: 150px;" readonly>
                      <?php } else { ?>
                        <br>Pada Tanggal : <input type="text" name="pak_tgl" value="<?= $tgl_akhir; ?> " style="width: 150px;" readonly>
                      <?php } ?>
                    </p>
                    <hr class="h" />
                    <?php if ((date("m", strtotime($tgltmt)) > 5)  && (date("Y", strtotime($tgltmt)) >= 2021)) { ?>
