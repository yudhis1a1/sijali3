			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx1">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0001" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx2">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0002" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx3">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0003" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx4">
				...
				<td rowspan="7" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0004" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx5">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0005" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx6">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0006" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx7">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0007" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx8">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0008" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx9">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0009" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx10">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0010" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx11">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0011" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx12">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0012" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx13">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0013" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx14">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0014" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx15">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0015" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx16">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0016" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx17">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0017" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx18">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0018" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx19">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0019" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx20">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0020" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx21">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0021" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx22">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0022" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx23">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0023" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx24">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0024" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx25">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0025" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx26">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0026" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx27">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0027" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx28">
				...
				<td rowspan="2" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0028" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx29">
				...
				<td rowspan="3" style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0029" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx30">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0030" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx31">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0031" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx32">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0032" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx33">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0033" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx34">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0034" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx35">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0035" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx36">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0036" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx37">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0037" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx38">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0038" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx39">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0039" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
			...
			<tr class="text-center" bgcolor="<?= $warna ?>" id="trx40">
				...
				<td style="white-space: nowrap">
					...
					?>
						...
						<a data-target="#Modalnilai-A0040" data-toggle="modal" class="btn btn-xs btn-success"><i class=" fa fa-edit"></i></a>
					<?php } ?>
...
?>
	...
	<form method="post" action="<?= base_url() ?>ketenagaan/ketenagaan/pushnilai_kum/<?php echo $no; ?>" role="form" enctype="multipart/form-data">
		<div id="Modalnilai-<?= $rd->dupak_no ?>" class="modal fade" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<input type="number" min="0" name="nilai_kum" value="<?= $rd->kum_penilai_baru ?>" step=".01" required />
					</div>
					<div class="modal-footer">
						<button type="submit" class="btn btn-primary">Simpan</button>
						<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
