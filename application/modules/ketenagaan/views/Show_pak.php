    ...
    <div class="card">
      <div class="card-body">
        ...
        <?php } else { ?>
          ...
          <?php } elseif ($usulan_status_id == '6' || $usulan_status_id == '14') { ?>
            ...
            <tbody>
              ...
              <tr>
                <center>
                  <div style="font-size:20px;">
                    ...
                    <?php } else { ?>
                      <br> <b style="font-weight:bold;">Masa Penilaian : Tanggal <?= $masa_awal_tgl ?> s/d <?= $tgl_akhir ?> </b>
                    <?php } ?>
                  </div>
                </center>
              </tr>
              ...
              <?php } else { ?>
                ...
                <tr>
                  ...
                  <?php } else { ?>
                    <td colspan="5"><?= $lama_thn ?> Tahun <?= $lama_bln ?> Bulan</td>
                  <?php } ?>
                ...
                <?php } else { ?>
                  <tr>
                    ...
                    <td colspan="2"></td>
                    <td width='80'>b. Baru</td>
                    <td colspan="5"><?= $baru_thn ?> Tahun <?= $baru_bln ?> Bulan</td>
                  </tr>
                <?php } ?>
                <tr>
