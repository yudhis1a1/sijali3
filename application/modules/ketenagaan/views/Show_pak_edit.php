  ...
  echo $tmt_dosen;
          ...
          ?> <table class="cust-print-table cust-table-bordered">
            ...
            <tbody>
              ...
              <?php if ($jab_rwy_pak->tmt_jab_dosen != '0000-00-00') { ?>
                <tr>
              ...
              <?php } else { ?>
                ...
                <tr>
                  ...
                  if (substr($resume->instansi_kode, 0, 3) == '031' || substr($resume->instansi_kode, 0, 3) == '032') { ?>
                    ...
                    <td colspan="5"><?= $resume->fakultas ?> / <?php if ($jab_rwy_pak->prodi_homebase_pak) {
                                                                  echo $jab_rwy_pak->prodi_homebase_pak;
                                                                } else {
                                                                  echo $resume->nama_prodi . ' ' . $jenjang_prodi->nama_jenjang;
                                                                } ?></td>
                  <?php } else {  ?>
