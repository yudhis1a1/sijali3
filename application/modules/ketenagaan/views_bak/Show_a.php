...
<a href="<?= base_url()?>ketenagaan/ketenagaan/print_bidanga/<?php echo $no; ?>" target="_blank" class="btn btn-success fa fa-print"> BIDANG A</a>
<a href="<?= base_url()?>ketenagaan/ketenagaan/print_dupak/<?php echo $no; ?>" target="_blank" class="btn btn-success fa fa-print"> PRINT DUPAK</a>
	 ...
	 ?>
		...
		<a href="<?= base_url()?>ketenagaan/usulan_dupak/dupak/A0002/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20" target='_BLANK'><i class="fa fa-search"></i></a>
