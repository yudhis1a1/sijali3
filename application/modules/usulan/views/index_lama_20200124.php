...
<script >
	$(document).ready(function(){ // Ketika halaman sudah diload dan siap
		$("#btn-tambah-form").click(function(){ // Ketika tombol Tambah Data Form di klik
            ...
            var q2 = "<select name='uraian[]' class='form-control select2' style='width: 450px' data-placeholder='Pilih Mata Kuliah..' required><?php foreach($ajar_dosen as $ajar) { ?> <option value='<?php echo $ajar->NMMK; ?>'><?php echo $ajar->NMMK; ?></option> <?php } ?> </select>";
