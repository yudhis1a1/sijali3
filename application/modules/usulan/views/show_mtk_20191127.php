            ...
            <div class="card-body">                              
                                 <div class="table-responsive">
                                    <table class="table color-table info-table">
										...
										$no=1;
										$mtk="SELECT * FROM `ajar_dosen` where NIDN='$r_nidn[nidn]' GROUP BY KODEMK ORDER BY SEMESTER ASC";
										$da_mtk=mysqli_query($koneksi,$mtk);
										while($r_mtk=mysqli_fetch_array($da_mtk))
										{
										?>
										<tr>
											<td >
