                        ...
                        <tbody style="vertical-align: top;">
                              ...
                              <tr>
								...
								<tr>
									  ...
									  <td colspan="6" style="background-color: #e4e4e4; font-weight: bold;">Semester <?=$r_a0004['semester']?> <?=$r_a0004['tahun_akademik']?>
									  </td>
									  ...
									  $q1="SELECT
										...
										while($row=mysqli_fetch_array($data_q1))
											...
											if($jabatan_no=='43' || $jabatan_no=='44')
											{
												if($total_sks<11)
												{
                              ...
                              <tr style="background-color: #e4e4e4; font-weight: bold;">
								...
								$c_A1516=mysqli_num_rows($d_A1516);
								if($c_A1516>0)
								{
								?>
                              <tr>
