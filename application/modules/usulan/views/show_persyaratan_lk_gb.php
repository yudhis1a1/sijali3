  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        ...
        <?php
        $usulan_status = $this->db->query("select usulan_status_id from usulans where no='$no' and usulan_status_id in ('1','2','3','10')")->num_rows();
        ?>
        <!-- Tab panes -->
                  ...
                  <table class="table color-table info-table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php if (isset($ceklis->formasi_jafung)) { ?>
                          <td class="text-center" style="width: 50px;">
                          ...
                          <td class="text-center" style="width: 50px;">
                            <?php if ($role == '4' && $usulan_status == '1') { ?> <a href="<?= base_url() ?>usulan/usulan/hapus_syarat/<?= $ceklis->formasi_jafung ?>/<?= $ceklis->usulan_no ?>/formasi_jafung" class="btn btn-xs btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                            <?php
                            } else {
                            } ?>
                          </td>
                        <?php } else { ?>
                          <td class="text-center" style="width: 50px;" colspan="2">
                            <?php if ($role == '4' && $usulan_status == '1') { ?> <a href="#uploadModal" data-toggle="modal" data-nama="formasi_jafung" data-judul="Upload Dokumen Formasi Jabatan Fungsional" class="btn btn-xs btn-warning"><i class="fa fa-upload"></i></a>
                            <?php
                            } else {
                            } ?>
                          </td>
                      ...
                      $diff = date_diff(date_create($isi->lahir_tgl), date_create());
                      ?>

                      <input type="hidden" name="selisih_thn" value="<?= $diff->y ?>">

                      <?php
                      // surat mendekati pensiun 
                      if (((substr($isi->nidn, 0, 2) == '88' || substr($isi->nidn, 0, 2) == '89') && $diff->y >= '68') || ((substr($isi->nidn, 0, 2) <> '88' && substr($isi->nidn, 0, 2) <> '89') && $diff->y >= '63')) {
                      ?>
                        <tr>
                          <td class="text-center">22</td>
                          <td>Surat Pernyataan Mendekati Pensiun (<a href="<?= base_url() ?>usulan/usulan/pensiun/<?= $no ?>" target="_blank">Format Terlampir</a>)</td>
                          <?php if (isset($ceklis->file_pensiun)) { ?>
                            <td class="text-center" style="width: 50px;">
                              <a href="<?= base_url() ?>assets/download_syarat/<?= $ceklis->file_pensiun ?>" target="_blank" class="btn btn-xs btn-info"><i class="fa fa-search"></i></a>
                            </td>
                            <td class="text-center" style="width: 50px;">
                              <?php if ($role == '4' && $usulan_status == '1') { ?> <a href="<?= base_url() ?>usulan/usulan/hapus_syarat/<?= $ceklis->file_pensiun ?>/<?= $ceklis->usulan_no ?>/file_pensiun" class="btn btn-xs btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                              <?php
                              } else {
                              } ?>
                            </td>
                          <?php } else { ?>
                            <td class="text-center" style="width: 50px;" colspan="2">
                              <?php if ($role == '4' && $usulan_status == '1') { ?> <a href="#uploadModal" data-toggle="modal" data-nama="file_pensiun" data-judul="Upload Surat Pernyataan Mendekati Pensiun" class="btn btn-xs btn-warning"><i class="fa fa-upload"></i></a>
                              <?php
                              } else {
                              } ?>
                            </td>
