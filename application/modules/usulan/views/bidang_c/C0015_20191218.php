		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<td><?=$row->keterangan?><br><a href="<?= base_url()?>usulan/usulan_dupak_c/download_bidangc/<?=$row->berkas?>" class="btn  btn-success" ><i class="fa  fa-cloud-download"></i>[PDF]</a></td>
					<td>
					...
					<a href="<?= base_url()?>usulan/usulan_dupak_c/hapus_C0015/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/C0015/<?=$kum?>" class="btn btn-danger tombol-hapus">
