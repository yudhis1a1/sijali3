			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<?php  if(isset($row->berkas)){ ?>
						...
						<?php }else{ ?>
							<a href="<?= base_url()?>usulan/usulan_dupak_c/download_bidangc/<?=$row->berkas?>" class="btn btn-xs btn-success" ><i class="fa  fa-cloud-download"></i>[Surat Tugas]</a>
							<a href="<?= base_url()?>usulan/usulan_dupak_c/hapus_berkas/<?=$row->berkas?>/<?= $row->usulan_no ?>/berkas/C0004" class="btn btn-xs btn-danger tombol-hapus"><i class="fa fa-trash"></i></a><br>
						<?php } ?>
					<?php  }else{ ?>
						<?php if($role<>'3'){?>
					...
					<?php  if(isset($row->sertifikat)){ ?>
						...
						<?php }else{ ?>
							<a href="<?= base_url()?>usulan/usulan_dupak_c/download_bidangc/<?= $row->sertifikat ?>" target="_blank" class="btn btn-xs btn-success" ><i class="fa  fa-cloud-download"></i>[Sertifikat]</a>
							<a href="<?= base_url()?>usulan/usulan_dupak_c/hapus_berkas/<?=$row->sertifikat?>/<?= $row->usulan_no ?>/sertifikat/C0004" class="btn btn-xs btn-danger tombol-hapus">
					...
					<a href="<?= base_url()?>usulan/usulan_dupak_c/hapus_C0001/<?=$row->no?>/<?=$row->usulan_no?>/C0004/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak_c/tambah_C0001/C0004/<?= $kum ?>" role="form" enctype="multipart/form-data">
...
<!-- Modal Upload -->
<?php foreach($q3->result() as $row){?>
<form  method="post" action="<?= base_url()?>usulan/usulan_dupak_c/upload_file/C0004" role="form" enctype="multipart/form-data">
