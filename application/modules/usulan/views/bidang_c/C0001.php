...
<div class="row">
	...
	<div class="card-body">
	  	<div class="tile">
  		    <h3>Bidang C</h3>
			<b>Menduduki jabatan pimpinan</b><br>
		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>usulan/usulan_dupak_c/hapus_C0001/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->dupak_no?>/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak_c/tambah_C0001/C0001/<?= $kum ?>" role="form" enctype="multipart/form-data">
		<div class="modal-body">
			...
			<hr>
                ...
                <!-- <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="berkas">SK Surat Tugas</label>
...
<!-- Modal Upload -->
<?php foreach($q3->result() as $row){?>
<form  method="post" action="<?= base_url()?>usulan/usulan_dupak_c/upload_file/C0001" role="form" enctype="multipart/form-data">
