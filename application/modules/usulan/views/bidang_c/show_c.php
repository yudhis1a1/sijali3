		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item"> <a class="nav-link active" href="<?= base_url() ?>usulan/usulan/bidangC/<?php echo $no; ?>"><span class="hidden-sm-up"><i class="ti-agenda "></i></span> <span class="hidden-xs-down">Bidang C</span></a> </li>
										...
										<table class="table color-table info-table table-bordered">
											...
											<thead>
												<tr class="text-center">
													...
													<th colspan="6" class="text-center">UNSUR YANG DINILAI</th>
											...
											<tbody>
												<tr class="text-center">
													<td rowspan="31">IV</td>
													<td colspan="3" class="text-left">PELAKSANAAN PENGABDIAN KEPADA MASYARAKAT</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr class="text-center">
													<td rowspan="4">A</td>
													<td colspan="2" class="text-left">Menduduki jabatan pimpinan</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr class="text-center">
													<td rowspan="3">1</td>
													<td colspan="1" rowspan="3" class="text-left">Menduduki jabatan pimpinan pada lembaga pemerintahan/pejabat negara yang harus dibebaskan dari jabatan organiknya</td>
												...
												<tr class="text-center">
													<td rowspan="3">B</td>
													<td colspan="2" class="text-left">Melaksankan pengembangan hasil pendidikan dan penelitian</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr class="text-center">
													<td rowspan="2">1</td>
													<td colspan="1" rowspan="2" class="text-left">Melaksanakan pengembangan hasil pendidikan dan penelitian yang dapat dimanfaatkan oleh
														masyarakat</td>
												...
												<tr class="text-center">
													<td rowspan="11">C</td>
													<td colspan="2" class="text-left">Memberi latihan/penyuluhan/penataran/ceramah pada masyarakat</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												<tr class="text-center">
													<td rowspan="10">1</td>
													<td colspan="1" class="text-left">Terjadwal/terprogram</td>
													<td></td>
													<td></td>
													<td></td>
													<td></td>
												...
												?>
												<tr class="text-center">
													<td class="text-left">1) Tingkat internasional</td>
												...
												?>
												<tr class="text-center">
													<td class="text-left">2) Tingkat nasional</td>
												...
												?>
												<tr class="text-center">
													<td class="text-left">3) Tingkat lokal</td>
												...
												?>
												<tr class="text-center">
													<td class="text-left">4) Insidental</td>
												...
												<tr class="text-center">
													<td rowspan="5">D</td>
													<td colspan="2" rowspan="2" class="text-left">Memberi pelayanan kepada masyarakat atau kegiatan lain yang menunjang pelaksanaan tugas
												...
												<tr class="text-center">
													<td>1</td>
													<td colspan="1" class="text-left">Berdasarkan bidang keahlian</td>
												...
												<tr class="text-center">
													<td>2</td>
													<td colspan="1" class="text-left">Berdasarkan penugasan lembaga perguruan tinggi</td>
												...
												<tr class="text-center">
													<td>3</td>
													<td colspan="1" class="text-left">Berdasarkan fungsi / jabatan</td>
												...
												<tr class="text-center">
													<td rowspan="1">E</td>
													<td colspan="2" class="text-left">Membuat/ menulis karya pengabdian</td>
												...
												<tr class="text-center">
													<td>F</td>
													<td colspan="2" class="text-left">Hasil kegiatan pengabdian kepada masyarakat yang dipublikasikan di sebuah berkala/jurnal pengabdian kepada masyarakat atau teknologi tepat guna, merupakan diseminasi dari luaran program kegiatan pengabdian kepada masyarakat, tiap karya</td>
												...
												<tr class="text-center">
													<td rowspan="5">G</td>
													<td colspan="2" rowspan="2" class="text-left">Berperan serta aktif dalam pengelolaan jurnal ilmiah (per tahun)*</td>
													<td rowspan="2"></td>
													<td rowspan="2"></td>
													<td rowspan="2"></td>
													<td rowspan="2"></td>
												...
												<tr class="text-center">
													<td>1</td>
													<td colspan="1" class="text-left">Editor/dewan penyunting/dewan redaksi jurnal ilmiah internasional</td>
												...
												<tr class="text-center">
													<td>2</td>
													<td colspan="1" class="text-left">Editor/dewan penyunting/dewan redaksi jurnal ilmiah nasional</td>
					...
					WHERE usulan_no = '$no'
					  AND LEFT(dupak_no, 1) = 'C'";
												...
												<tr style="background-color: #e4e4e4; font-weight: bold;">
													<td colspan="4" class="text-right"><b>JUMLAH BIDANG C</b></td>
