	...
	$(document).ready(function(){ // Ketika halaman sudah diload dan siap
		$("#btn-tambah-form").click(function(){ // Ketika tombol Tambah Data Form di klik
			...
			$("#insert-form").append("<h4>Data Mata Kuliah ke " + nextform + " :</h4>" +
				...
				"<tr>" +
				"<td>SKS/mtk</td>" +
				"<td><input type='text' id='txt4'  onkeyup='sum()' name='sks[]' required></td>" +
				"<td>Volume</td>" +
				"<td><input type='text' id='txt5'  onkeyup='sum()' name='jumlah_volume[]' required></td>" +
				"</tr>" +
				"<tr>" +
				"<td>Keterangan</td>" +
	...
	$(document).ready(function(){ // Ketika halaman sudah diload dan siap
		$("#btn_tambah_form_mhs").click(function(){ // Ketika tombol Tambah Data Form di klik
			...
			$("#insert_form_mhs").append("<h4>Data Mahasiswa ke " + nextform + " :</h4>" +
				...
				"<tr>" +
				"<td>Nama Mahasiswa : " +
				"<input type='text' name='mhs[]' style='width:500px;'><input type='hidden' name='no_usulan_detail[]' value='" + next_usulan + "'></td>" +
				"</tr>" +
				"</table>");
		...
		$("#btn_tambah_form_keg").click(function(){ // Ketika tombol Tambah Data Form di klik
			...
			$("#insert_form_keg").append("<h4>Data Kegiatan ke " + nextform + " :</h4>" +
				...
				"<div class='col-md-12'>"+
					...
					"<textarea name='mhs[]' class='form-control' rows='2' maxlength='255'></textarea>"+
