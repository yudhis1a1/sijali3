...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <center>
                    <h3>Rekap Usulan Per Bentuk PT<br> Tahun <?= $tahun ?></h3>
                </center>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <div align="center">
                                            <a style="color:Blue" href="<?= base_url() ?>usulan/pimpinan/tampil_rekap_pt/031/<?= $tahun ?>/<?= $pt[$index] ?>" target="_blank">
                                                <h5><?= $univ->jml ?></h5>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        ?>
                                        <div align="center">
                                            <a style="color:Blue" href="<?= base_url() ?>usulan/pimpinan/tampil_rekap_pt/032/<?= $tahun ?>/<?= $pt[$index] ?>" target="_blank">
                                                <h5><?= $inst->jml ?></h5>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        ?>
                                        <div align="center">
                                            <a style="color:Blue" href="<?= base_url() ?>usulan/pimpinan/tampil_rekap_pt/033/<?= $tahun ?>/<?= $pt[$index] ?>" target="_blank">
                                                <h5><?= $st->jml ?></h5>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        ?>
                                        <div align="center">
                                            <a style="color:Blue" href="<?= base_url() ?>usulan/pimpinan/tampil_rekap_pt/034/<?= $tahun ?>/<?= $pt[$index] ?>" target="_blank">
                                                <h5><?= $aka->jml ?></h5>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        ?>
                                        <div align="center">
                                            <a style="color:Blue" href="<?= base_url() ?>usulan/pimpinan/tampil_rekap_pt/035/<?= $tahun ?>/<?= $pt[$index] ?>" target="_blank">
                                                <h5><?= $poli->jml ?></h5>
                                            </a>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        ?>
                                        <div align="center">
                                            <a style="color:Blue" href="<?= base_url() ?>usulan/pimpinan/tampil_rekap_pt/036/<?= $tahun ?>/<?= $pt[$index] ?>" target="_blank">
                                                <h5><?= $aka_kom->jml ?></h5>
                                            </a>
                                        </div>
                                    </td>
