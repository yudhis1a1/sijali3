                  ...
                  <table class="table color-table info-table">
                    ...
                    <tbody>
                      ...
                      ?>
                        ...
                        <?php } ?>
                      <?php
                      } elseif ($jabatan_no <> '31') { // jika mengajukan usulan kenaikan/loncat jabatan
                      ?>
                        <tr>
                          <td class="text-center">17</td>
                        ...
                        ?>
                          ...
                          ?>
                        <?php
                        } else { // jika usulan yg diajukan dibawah LK/GB
                        ?>
                          <?php
                          // jika NIDK
                          if (substr($isi->nidn, 0, 2) == '88' || substr($isi->nidn, 0, 2) == '89') {
