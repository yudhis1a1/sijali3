    ...
    <div class="row" id="validation">
        <div class="col-12">
            <div class="card wizard-content">
                <div class="card-body">
                    <form action="<?php echo base_url() . 'usulan/usulan/tambah_usulan_naik_jab_reg' ?>" method="post" enctype="multipart/form-data" class="validation-wizard wizard-circle" id="form-submit">
                        <!-- Step 1 -->
                        <h6>Identitas Diri</h6>
                        <section>
                            <div class="card-header bg-info">
                                <h4 class="m-b-0 text-white">IDENTITAS DOSEN</h4>
                                <?php
                                ...
                                <input type="hidden" name="ikatan_kerja_kode" value="<?= $ikatan_kerja_kode ?>">
                            </div>
                            <hr>
                            <div class="row">
                                <?php
                            ...
                            ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            if ($row->jabatan_no == '41' || $row->jabatan_no == '40') {
                                            ?>
                                                <div class="controls">
								...
								WHERE a.`jabatan_kode` = b.`kode`
								  ...
								  AND a.`jabatan_kode` IN ('43', '44')";
                                            ...
                                            <?php
                                            } elseif ($row->jabatan_no == '43' || $row->jabatan_no == '44') {
                                            ?>
                                                <div class="controls">
                                                    <select name="jabatan_usulan_no" required data-validation-required-message="Data usulan jabatan belum dipilih" class="select2 m-b-10 select2-multiple" style="width: 100%" id="jabatan_usulan_no" data-placeholder="Click to Choose...">
                                                        <option value=""></option>
								...
								WHERE a.`jabatan_kode` = b.`kode`
								  ...
								  AND a.`jabatan_kode` IN ('46', '47','48')";
                                            ...
                                            <?php
                                            } elseif ($row->jabatan_no == '46' || $row->jabatan_no == '47' || $row->jabatan_no == '48') {
                                            ?>
                                                <div class="controls">
                                                    <select name="jabatan_usulan_no" required data-validation-required-message="Data usulan jabatan belum dipilih" class="select2 m-b-10 select2-multiple" style="width: 100%" id="jabatan_usulan_no" data-placeholder="Click to Choose...">
                                                        <option value=""></option>
