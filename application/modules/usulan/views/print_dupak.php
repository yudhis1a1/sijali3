<script>
	alert("Gunakan browser Mozilla Firefox untuk cetak yang lebih optimal.")
</script>
<!DOCTYPE html>
<?php
include "koneksi.php";
									...
									<table id="table-header" class="cust-table cust-table-bordered">
										...
										<tbody>
											...
											<tr>
												...
												<td><?= $row_dos['lahir_tempat'] ?>, <?= tgl_indo($row_dos['lahir_tgl']) ?></td>
											</tr>
											<tr>
										...
										WHERE a.`no` = '$no_usulan'
										  AND a.pimpinan_jabatan = b.`id`";
												...
												<td class="text-center">
													<?= $row_pim['tempat_surat'] ?>, <?= tgl_indo($row_pim['tgl_surat']) ?>
													<br>&nbsp;
													<strong><?= $row_pim['japim'] ?> <?= $row_dos['nama_instansi'] ?></strong>
													<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;<br>&nbsp;
													<strong><?= $row_pim['pimpinan_nama'] ?></strong>
													<br>NIDN/NIP/NIK. <?= $row_pim['pimpinan_nidn'] ?>/<?= $row_pim['pimpinan_nip'] ?>
												</td>
											</tr>
