		...
		<div class="card">
			<div class="card-body">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li class="nav-item"> <a class="nav-link active" href="<?= base_url() ?>usulan/usulan/bidangB/<?php echo $no; ?>"><span class="hidden-sm-up"><i class="ti-agenda "></i></span> <span class="hidden-xs-down">Bidang B</span></a> </li>
				...
				<div class="tab-content tabcontent-border">
					...
					<div class="tab-pane active p-20" id="dasar" role="tabpanel">
                        ...
                        <div class="card border-info">
                            <div class="card-header bg-info">
                                <h4 class="m-b-0 text-white">Template Peer Review</h4></div>
                            <div class="card-body">
							<a href="<?= base_url() ?>files/Peer Review Paten.docx" target="_blank" class="btn btn-success fa fa-file-word-o"> PATEN</a>
							<a href="<?= base_url() ?>files/Peer Review Prosiding.docx" target="_blank" class="btn btn-success fa fa-file-word-o"> PROSIDING</a>
							<a href="<?= base_url() ?>files/Peer Review Jurnal.docx" target="_blank" class="btn btn-success fa fa-file-word-o"> JURNAL</a>
							<a href="<?= base_url() ?>files/Peer Review Buku.docx" target="_blank" class="btn btn-success fa fa-file-word-o"> BUKU</a>
							<a href="<?= base_url() ?>files/Peer Review Penyadur atau penerjemah Buku.docx" target="_blank" class="btn btn-success fa fa-file-word-o"> Penyadur Atau Penerjemah Buku</a>
                            </div>
                        </div>
                    </div> -->
									...
									<div class="table-responsive m-t-40">
										<table width="100%" class="table color-table info-table table-bordered">
											...
											<tbody>
												...
												<tr>
													...
													<td colspan="4">
														<div align="justify">3) Jurnal internasional terindeks pada
															basis data internasional di luar kategori 2
														</div>
													</td>
												...
												<tr>
													<td>&nbsp;</td>
													<td colspan="4">5) a) Jurnal Nasional berbahasa Inggris atau bahasa resmi (PBB) terindeks pada basis data yang diakui Kemenristekdikti contohnya: CABI atau Index Copernicus International (ICI) atau Jurnal nasional terakreditasi peringkat 3 dan 4 </td>
												...
												<tr>
													<td>&nbsp;</td>
													<td colspan="4">b) Jurnal Nasional berbahasa Indonesia terindeks pada basis data yang diakui Kemenristekdikti, contohnya: akreditasi peringkat 5 dan 6</td>
												...
												<tr>
													...
													<td style="vertical-align: middle;">
														...
														<a href="<?= base_url() ?>usulan/usulan_dupak_b/dupak/B0039/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
												...
												<tr>
													...
													<td colspan="4">
														<div align="justify">
															<!-- <strong>Menambahkan Sisa Angka Kredit pada Jabatan Sebelumnya (AK x 40%)</strong></div> -->
													</td>
													<td style="vertical-align: middle;"><?= $data_bid_b_b0040['kum_usulan_lama']; ?></td>
													<td style="vertical-align: middle;"><?= $data_bid_b_b0040['kum_usulan_baru'] ?></td>
													<td style="vertical-align: middle;"><?= $jumlah_b0040; ?></td>
													<td style="vertical-align: middle;">
														<?php
														// if($jabatan_no<>'31')
														// {
														?>
														<!-- <a title="Update Angka Kredit" href="#" data-toggle="modal" data-target="#tambah"  class="btn btn-circle btn-success waves-effect waves-light m-t-20"><i class="fa fa-plus"></i></a>
		
		<a onclick="return confirm('Yakin dihapus?')" title="Hapus Angka Kredit" href="<?= base_url() ?>usulan/usulan_dupak_b/hapus_B0040/B0040/<?php echo $no; ?>" class="btn btn-circle btn-danger waves-effect waves-light m-t-20"><i class="fa fa-minus"></i></a> -->
														<?php
														// }else{}
														// 
														?>
...
<div class="modal fade" aria-labelledby="myModalLabel" id="tambah">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form method="post" action="<?= base_url() ?>usulan/usulan_dupak_b/tambah_B0040/B0040/<?php echo $no; ?>" role="form" enctype="multipart/form-data">
				<div class="modal-body">
					<h3>Bidang B</h3>
					<b>Masukkan Sisa Angka Kredit pada Jabatan Sebelumnya</b><br><br>
					<input type="text" name="ak" style="width:90px;" class="form-control" required><br>
