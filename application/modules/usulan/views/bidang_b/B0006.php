		...
		<div class="card">
			<div class="card-body">
				<div class="tile">
					...
					Jurnal Nasional berbahasa Inggris atau bahasa resmi (PBB) terindeks pada basis data yang diakui Kemenristekdikti contohnya: CABI atau Index Copernicus International (ICI) atau Jurnal nasional terakreditasi peringkat 3 dan 4
				</div>
			</div>
		</div>
	</div>
							...
							<table border="1" class="ui celled table" width="100%">
								<thead>
									<tr style="background-color: #e4e4e4; font-weight: bold;" class="text-center">
										...
										<th>URL</th>
										<th>Keterangan</th>
										<th>Jumlah Penulis/Penulis ke</th>
										<th>Syarat Khusus</th>
										<th>Satuan Hasil</th>
										<th>Angka Kredit</th>
										<th>Bukti Fisik</th>
								...
								<tbody>
									<?php foreach ($q3->result() as $row) { ?>
										<tr class="text-center">
											...
											<td>Jumlah penulis <?= $row->jml_penulis ?> / Penulis ke-<?= $row->penulis_ke ?></td>
											<td><?= $row->syarat ?></td>
											...
											<td>
												...
												<?php if ($usulan_status_id <> '1' && $usulan_status_id <> '2') {
													...
													<a href="<?= base_url() ?>usulan/usulan_dupak_b/hapus_B0005/<?= $row->no ?>/<?= $row->usulan_no ?>/<?= $row->berkas ?>/B0006/<?= $kum ?>" class="btn btn-danger tombol-hapus"><i class="fa fa-trash-o"></i></a>
							...
							<tr class="text-center">
								...
								if ($role == '4') {
									if ($usulan_status_id <> '10') {
										...
										<center><button type="submit" class="btn btn-warning">SIMPAN VALIDASI</button></center>
								<?php }
								}
								?>
							</tr>
					...
					<div class="row">
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="number" min="1" max="15" name="jp" class="form-control" id="jp" required>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="number" min="1" max="15" name="pk" class="form-control" id="pk" required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="url">Alamat Web Jurnal</label>
									<div class="input-group date">
										<input type="text" value="<?= $row->url_web ?>" name="url_web" class="form-control" placeholder="https://ojs.com/Jurnal.pdf" required>
									</div>
									<code>*Mulai tahun 2012, alamat ini harus mengarah ke web jurnal resmi, bukan sekedar repository. Sebaiknya, alamat ini langsung menuju ke artikel, bukan hanya halaman depan (homepage)</code>
								</div>
							</div>
