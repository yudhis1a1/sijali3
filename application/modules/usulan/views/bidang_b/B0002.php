								...
								<tbody>
									<?php foreach ($q3->result() as $row) { ?>
										<tr class="text-center">
											...
											<td>
												<a href="<?= base_url() ?>usulan/usulan_dupak_b/download_bidangb/<?= $row->berkas ?>" class="btn  btn-success"><i class="fa  fa-cloud-download"></i>[PDF]</a>
											</td>
											...
											<td>
												<?php if ($usulan_status_id <> '1' && $usulan_status_id <> '2') {
													...
													<a href="<?= base_url() ?>usulan/usulan_dupak_b/hapus_B0001/<?= $row->no ?>/<?= $row->usulan_no ?>/<?= $row->berkas ?>/B0002/<?= $kum ?>" class="btn btn-danger tombol-hapus">
	...
	<div class="modal fade" aria-labelledby="myLargeModalLabel" id="edit<?= $row->no; ?>">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form method="post" action="<?= base_url() ?>usulan/usulan_dupak_b/update_b0001/B0002" role="form" enctype="multipart/form-data">
					<div class="modal-body">
