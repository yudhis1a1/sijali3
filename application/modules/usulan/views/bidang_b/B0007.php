		...
		<div class="card">
			<div class="card-body">
				<div class="tile">
					...
					Jurnal Nasional berbahasa Indonesia terindeks pada basis data yang diakui Kemenristekdikti, contohnya: akreditasi peringkat 5 dan 6
				</div>
			</div>
		</div>
	</div>
										...
										<tr class="text-center">
											...
											<td>
												...
												<?php if ($usulan_status_id <> '1' && $usulan_status_id <> '2') {
													...
													<a href="<?= base_url() ?>usulan/usulan_dupak_b/hapus_B0005/<?= $row->no ?>/<?= $row->usulan_no ?>/<?= $row->berkas ?>/<?= $row->dupak_no ?>/<?= $kum ?>" class="btn btn-danger tombol-hapus">
