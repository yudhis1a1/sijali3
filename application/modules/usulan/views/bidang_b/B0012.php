			...
			<form method="post" action="<?= base_url() ?>usulan/usulan_dupak_b/tambah_B0004/<?= $dupak_no ?>/<?= $kum ?>" role="form" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<code>*Alamat menuju dokumen artikel ini (repository), meliputi : Halaman sampul, artikel/laporan dan keterangan keberadaan di perpustakaan</code>
							</div>
						</div>
					</div>
					...
					<!-- <div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="url">URL Peer Review (Opsional)</label>
								<div class="input-group date">
			...
			<div class="modal-content">
				...
				<form method="post" action="<?= base_url() ?>usulan/usulan_dupak_b/update_b0004/<?= $dupak_no ?>" role="form" enctype="multipart/form-data">
					<div class="modal-body">
						...
						<input type="hidden" name="isbn" value="<?= $row->isbn ?>" class="form-control" required>
						...
						<!-- <div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<label for="url">URL Peer Review (Optional)</label>
									<div class="input-group date">
