		...
		<div class="modal-content">
			...
			<form method="post" action="<?= base_url() ?>usulan/usulan_dupak_b/tambah_B0004/<?= $dupak_no ?>/<?= $kum ?>" role="form" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<input type="hidden" name="isbn" class="form-control">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="url">Alamat Website/URL Dokumen</label>
								<div class="input-group date">
									<input type="text" name="url" class="form-control" placeholder="https://repository.com/Jurnal.pdf" required>
								</div>
								<code>*Dapat berupa keterangan dan keberadaan karya teknologi/seni monumental dari pimpinan PT, foto karya teknologi/seni, keterangan pelaksanaan seni pertunjukan dari pimpinan PT, dokumentasi terkait dengan peran yang dilakukan (untuk seni pertunjukan), buku/naskah (untuk karya sastra)</code>
							</div>
						</div>
					</div>
				...
				<form method="post" action="<?= base_url() ?>usulan/usulan_dupak_b/update_b0004/<?= $dupak_no ?>" role="form" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="modal-body">
							...
							<input type="hidden" name="isbn" value="<?= $row->isbn ?>" class="form-control">

							<input type="hidden" name="url_web" value="<?= $row->url_web ?>" class="form-control" placeholder="https://ojs.com/Jurnal.pdf">
