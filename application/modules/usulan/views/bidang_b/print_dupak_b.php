								...
								<div class="table-responsive">
									<table id="table-bidang" class="cust-table cust-table-bordered">
										...
										<tbody style="vertical-align: top;">
											...
											$c_dupaks_b	= mysqli_num_rows($d_dupaks_b);
											if ($c_dupaks_b > 0) {
											?>
												<tr>
											...
											$c_dupaks_f = mysqli_num_rows($d_dupaks_f);
											if ($c_dupaks_f > 0) {
											?>
												<tr>
											...
											$c_dupaks_g = mysqli_num_rows($d_dupaks_g);
											if ($c_dupaks_g > 0) {
											?>
												<tr>
												...
												?>
													...
													$d_dup_g = mysqli_query($koneksi, $dup_g);
													while ($r_d_dup_g = mysqli_fetch_array($d_dup_g)) {
													?>
														<tr>
															<td class="text-center"><?= $no ?></td>
															<td colspan="2"><?= $r_d_dup_g['uraian'] ?></td>
															<td class="text-center"><?= $r_d_dup_g['tgl'] ?></td>
															<td class="text-center"><?= $r_d_dup_g['satuan_hasil'] ?></td>
															<td class="text-center"><?= $r_d_dup_g['jumlah_volume'] ?></td>
															<td class="text-center"><?= $r_d_dup_g['angka_kredit'] ?></td>
															<td class="text-center"><?= $r_d_dup_g['keterangan'] ?></td>
														</tr>
													<?php
														$no++;
													}
											...
											<?php
											$no_39 = 1;
											$B0039 = "select *from usulan_dupak_details where dupak_no='B0039' and usulan_no='$no_usulan'";
											$d_B0039 = mysqli_query($koneksi, $B0039);
											$c_B0039 = mysqli_num_rows($d_B0039);
											if ($c_B0039 > 0) {
											?>
												<tr>
													<td class="text-center">H</td>
													<td colspan="7"><strong>Membuat rancangan dan karya seni yang tidak terdaftar HaKI</strong></td>
												</tr>
												<?php
												while ($r_B0039 = mysqli_fetch_array($d_B0039)) {
												?>
													<tr>
														<td class="text-center"><?= $no_39 ?></td>
														<td colspan="2"><?= $r_B0039['uraian'] ?></td>
														<td class="text-center"><?= $r_B0039['tgl'] ?></td>
														<td class="text-center"><?= $r_B0039['satuan_hasil'] ?></td>
														<td class="text-center"><?= $r_B0039['jumlah_volume'] ?></td>
														<td class="text-center"><?= $r_B0039['angka_kredit'] ?></td>
														<td class="text-center"><?= $r_B0039['keterangan'] ?></td>
													</tr>
												<?php
													$no_39++;
												}
												...
												$data_bid_a_B0039 = mysqli_fetch_array($data_B0039);
												$jumlah_B0039 = $data_bid_a_B0039['kum_usulan_lama'] + $data_bid_a_B0039['kum_usulan_baru'];
												?>
												<tr style="background-color: #e4e4e4; font-weight: bold;">
													<td></td>
													<td colspan="5">Sub Jumlah</td>
													<td class="text-center"><?= $jumlah_B0039 ?></td>
													<td></td>
												</tr>
											<?php
											}
											...
											<?php
											$no_40 = 1;
											$B0040 = "select *from usulan_dupak_details where dupak_no='B0040' and usulan_no='$no_usulan'";
											$d_B0040 = mysqli_query($koneksi, $B0040);
											$c_B0040 = mysqli_num_rows($d_B0040);
											if ($c_B0040 > 0) {
												$r_B0040 = mysqli_fetch_array($d_B0040);
											?>
												<tr>
													<td class="text-center">I</td>
													<td colspan="5"><strong>Menambahkan Sisa Angka Kredit pada Jabatan Sebelumnya (AK x 40%)</strong></td>
													<td class="text-center"><?= $r_B0040['angka_kredit'] ?></td>
												</tr>
											<?php
											}
											?>
