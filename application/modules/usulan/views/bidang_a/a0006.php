		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>usulan/usulan_dupak/hapus_a0005/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/A0006/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak/tambah_a0005/A0006/<?= $kum ?>" role="form" enctype="multipart/form-data">
		<div class="modal-body">
		
				<h3>BIDANG A</h3>
				<b>Membimbing mahasiswa kuliah kerja nyata, pratek kerja nyata, praktek kerja lapangan</b><br>
				Membimbing mahasiswa kuliah kerja nyata, pratek kerja nyata, praktek kerja lapangan
                <hr>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="berkas">Surat Tugas</label>
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="edit<?=$row->no;?>" >
	...
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak/update_a0003/A0006" role="form" enctype="multipart/form-data">
		<div class="modal-body">
		<h3>BIDANG A</h3>
				<b>Membimbing mahasiswa kuliah kerja nyata, pratek kerja nyata, praktek kerja lapangan</b><br>
				Membimbing mahasiswa kuliah kerja nyata, pratek kerja nyata, praktek kerja lapangan
