			...
			?>
				<div class="card-body">
					...
					<table border="1" class="ui celled table" width="100%">
						...
						{?>
							<a href="<?= base_url()?>usulan/usulan_dupak/download_bidanga/<?=$q1->bukti_kinerja?>"  class="btn btn-xs btn-success" ><i class="fa  fa-cloud-download"></i>[File Tesis]</a>
						...
						{ ?>
							<a href="#uploadModal" data-toggle="modal" data-nama="bukti_kinerja,<?=$q1->no?>" data-judul="Upload File Tesis" class="btn  btn-sm btn-warning" ><i class="fa fa-upload"></i>[File Tesis]</a><br>
						<?php  
						} 
						?>
						<br>
