		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>usulan/usulan_dupak/hapus_a0005/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/A0029/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak/tambah_a0005/A0029/<?= $kum ?>" role="form" enctype="multipart/form-data">
...
<?php foreach($q3->result() as $row){?>
	...
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak/update_a0003/A0029" role="form" enctype="multipart/form-data">
		<div class="modal-body">
				<h3>BIDANG A</h3>
				<b>Menduduki jabatan pimpinan perguruan tinggi</b><br>
				Ketua jurusan pada politeknik/akademi/sekretaris jurusan /bagian pada universitas/ institut/ sekolah tinggi
