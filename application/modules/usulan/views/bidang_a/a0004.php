...
<div class="modal fade" aria-labelledby="myLargeModalLabel" id="tambah">
	<div class="modal-dialog modal-lg text-justify">
		<div class="modal-content">
			...
			<form method="post" action="<?= base_url() ?>usulan/usulan_dupak/tambah_a0004/A0004" role="form" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<div class="row">
						...
						<table class="table nowarp table-bordered">
							<thead>
								<tr style="background-color: #e4e4e4;">
									<th width="20">#</th>
									<th>Mata Kuliah</th>
