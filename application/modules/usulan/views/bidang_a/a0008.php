							...
							<tr style="background-color: #e4e4e4; font-weight: bold;">
								...
								<td>
									<?php if ($role <> '3' || $usulan_status_id <> '1' && $usulan_status_id <> '2') {
										...
										<a href="<?= base_url() ?>usulan/usulan_dupak/hapus_a0007/<?= $row_thn['NO'] ?>/<?= $row_thn['usulan_no'] ?>/<?= $row_thn['semester'] ?>/<?= $row_thn['tahun_akademik'] ?>/A0008/<?= $kum ?>" class="btn btn-danger tombol-hapus"> Hapus
							...
							<tr style="background-color: #e4e4e4;">
								...
								<td>Surat Tugas :
									<?php if (isset($row_thn['berkas'])) { ?>
										...
										<?php } else { ?>
											<a href="<?= base_url() ?>usulan/usulan_dupak/download_bidanga/<?= $row_thn['berkas'] ?>" class="btn btn-xs btn-success"><i class="fa  fa-cloud-download"></i>[Surat Tugas]</a>
											<a href="<?= base_url() ?>usulan/usulan_dupak/hapus_berkas/<?= $row_thn['berkas'] ?>/<?= $row_thn['usulan_no'] ?>/berkas/A0008" class="btn btn-xs btn-danger tombol-hapus">
									...
									<?php if (isset($row_thn['bukti_kinerja'])) { ?>
										...
										<?php  } else { ?>
											<a href="<?= base_url() ?>usulan/usulan_dupak/download_bidanga/<?= $row_thn['bukti_kinerja'] ?>" class="btn btn-xs btn-success"><i class="fa  fa-cloud-download"></i>[Bukti Kinerja]</a>
											<a href="<?= base_url() ?>usulan/usulan_dupak/hapus_berkas/<?= $row_thn['bukti_kinerja'] ?>/<?= $row_thn['usulan_no'] ?>/bukti_kinerja/A0008" class="btn btn-xs btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
										<?php  } ?>
									<?php  } else { ?>
										<?php if ($role <> '3') { ?>
...
<div class="modal fade" aria-labelledby="myLargeModalLabel" id="tambah">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form method="post" action="<?= base_url() ?>usulan/usulan_dupak/tambah_a0007/A0008/<?= $kum ?>" role="form" enctype="multipart/form-data">
				...
				<input type="hidden" id="kali" name="kali" value="3">
			</form>
