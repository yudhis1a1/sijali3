...
<div class="row">
	...
	<div class="card-body">
		...
		<tr style="background-color: #e4e4e4; font-weight: bold;">
			...
			<a href="<?= base_url()?>usulan/usulan_dupak/hapus_a0007/<?=$row_thn['NO']?>/<?=$row_thn['usulan_no']?>/<?=$row_thn['semester']?>/<?=$row_thn['tahun_akademik']?>/A0014/<?=$kum?>" class="btn btn-danger tombol-hapus"> Hapus
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>usulan/usulan_dupak/tambah_a0007/A0014/<?= $kum ?>" role="form" enctype="multipart/form-data">
