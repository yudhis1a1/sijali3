...
{
  if($role=='3'){
  $query = "SELECT  a.updated_at, a.no, b.nidn, b.nidk, b.nama, i.`nama_instansi`, h.`nama_prodi`, a.`jabatan_usulan_no`, e.`nama_jabatans`, e.`kum`, f.`nama_jenjang`, g.`nama_status` FROM usulans AS a, dosens AS b, jabatan_jenjangs AS d, jabatans AS e, jenjangs AS f, usulan_statuses AS g, prodis AS h, `instansis` AS i WHERE a.dosen_no = b.no AND b.`prodi_kode`=h.`kode` AND h.`instansi_kode`=i.`kode` AND a.`jabatan_usulan_no`=d.`no` AND d.`jabatan_kode`=e.`kode` AND d.`jenjang_id`=f.`id` AND a.`usulan_status_id`=g.`id` and b.nidn='$username' AND a.usulan_status_id in ('2','3','4','5','6','7','8','10') group by b.`nidn`";
}elseif($role=='4'){

  $query = "SELECT  a.updated_at, a.no, b.nidn, b.nidk, b.nama, i.`nama_instansi`, h.`nama_prodi`, a.`jabatan_usulan_no`, e.`nama_jabatans`, e.`kum`, f.`nama_jenjang`, g.`nama_status`, i.kode FROM usulans AS a, dosens AS b, jabatan_jenjangs AS d, jabatans AS e, jenjangs AS f, usulan_statuses AS g, prodis AS h, `instansis` AS i WHERE a.dosen_no = b.no AND b.`prodi_kode`=h.`kode` AND h.`instansi_kode`=i.`kode` AND a.`jabatan_usulan_no`=d.`no` AND d.`jabatan_kode`=e.`kode` AND d.`jenjang_id`=f.`id` AND a.`usulan_status_id`=g.`id` and i.kode='$instansi' AND a.usulan_status_id in ('2','3','4','5','6','7','8','10') group by b.`nidn`";
}else{
  $query = "SELECT  a.updated_at, a.no, b.nidn, b.nidk, b.nama, i.`nama_instansi`, h.`nama_prodi`, a.`jabatan_usulan_no`, e.`nama_jabatans`, e.`kum`, f.`nama_jenjang`, g.`nama_status` FROM usulans AS a, dosens AS b, jabatan_jenjangs AS d, jabatans AS e, jenjangs AS f, usulan_statuses AS g, prodis AS h, `instansis` AS i WHERE a.dosen_no = b.no AND b.`prodi_kode`=h.`kode` AND h.`instansi_kode`=i.`kode` AND a.`jabatan_usulan_no`=d.`no` AND d.`jabatan_kode`=e.`kode` AND d.`jenjang_id`=f.`id` AND a.`usulan_status_id`=g.`id` AND a.usulan_status_id in ('2','3','4','5','6','7','8','10') group by b.`nidn`";
