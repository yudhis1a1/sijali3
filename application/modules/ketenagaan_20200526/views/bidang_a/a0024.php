...
<div class="row">
	...
	<div class="card-body">
	  	<div class="tile">
  		    <h3>BIDANG A</h3>
					<b>Menduduki jabatan pimpinan perguruan tinggi</b><br>
	...
	<div class="card-body">
        ...
        <table border="1" class="ui celled table" width="100%">
			...
			<?php if($usulan_status_id=='3'){ ?>
				  ...
				  <input type="hidden" class="form-control" value="A0024" name="bidang" readonly>
		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<td><?=$row->keterangan?><br><a href="<?= base_url()?>ketenagaan/usulan_dupak/download_bidanga/<?=$row->berkas?>" class="btn  btn-success" ><i class="fa  fa-cloud-download"></i>[PDF]</a>
					<td>
					<?php if($usulan_status_id<>'1' && $usulan_status_id<>'2'){}else{ ?>
					<a href="<?= base_url()?>ketenagaan/usulan_dupak/hapus_a0005/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/A0024/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>ketenagaan/usulan_dupak/tambah_a0005/A0024/<?= $kum ?>" role="form" enctype="multipart/form-data">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="edit<?=$row->no;?>" >
	...
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>ketenagaan/usulan_dupak/update_a0001/A0018/<?= $kum ?>" role="form" enctype="multipart/form-data">
		<div class="modal-body">
				<h3>BIDANG A</h3>
				<b>Mengembangkan program kuliah	</b><br>
			Melakukan kegiatan pengembangan program kuliah	
                ...
                <div class="form-group">
                  ...
                  <textarea name="uraian" class="form-control" id="uraian" rows="2" required><?= $row->uraian; ?></textarea>
									<input type="hidden" name="no_dupak" value="<?= $row->no; ?>"required>
				  <input type="hidden" name="no_usulan" value="<?= $row->usulan_no; ?>"required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="hidden" step="any" name="jumlah_volume" value="<?=$row->jumlah_volume?>" class="form-control" id="jumlah_volume"  min="0" >
                    </div>
                  </div>
                </div>
