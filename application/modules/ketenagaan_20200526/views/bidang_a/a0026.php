	...
	<div class="card-body">
        ...
        <table border="1" class="ui celled table" width="100%">
			...
			<?php if($usulan_status_id=='3'){ ?>
				  ...
				  <input type="hidden" class="form-control" value="A0026" name="bidang" readonly>
		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>ketenagaan/usulan_dupak/hapus_a0005/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/A0026/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>ketenagaan/usulan_dupak/tambah_a0005/A0026/<?= $kum ?>" role="form" enctype="multipart/form-data">
