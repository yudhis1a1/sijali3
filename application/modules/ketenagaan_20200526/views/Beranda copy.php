...
?>  
 ...
 <div class="modal fade"  aria-labelledby="myLargeModalLabel" id="myModal-<?=$row_dos['no_usulan'] ?>" >
	<div class="modal-dialog modal-lg">
		...
		<table width="100%" border="1">
		 ...
		 // $da_gol=mysqli_query($koneksi,$gol);
		  ...
		  <tr>
			...
			<td colspan="8">&nbsp;<?=$row_dos['nama_jabatans']?>, <?=tgl_indo($row_dos['jabatan_tgl'])?></td>
		  </tr>
		  <?php
		  $pend=$this->db->query("SELECT
					 a.id_sdm,
					 a.thn_lulus,
					 a.nm_sp_formal,
					 b.nama_jenjang,
				...
				WHERE
					...
					AND a.id_bid_studi=c.kode")->result_array();
		//  $da_pend=mysqli_query($koneksi,$pend);
		  ...
		  <tr>
			<td colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>A</strong></div></td>
			<td colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>B</strong></div></td>
			<td colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>C</strong></div></td>
			<td colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>D</strong></div></td>
			<td colspan="2" bgcolor="#CCCCCC"><div align="center"><strong>E</strong></div></td>
		  ...
		  <tr>
			...
			<?php
			//bidang a
			$data_bid_a_a0004=$this->db->query("select *from usulan_dupaks where dupak_no='A0004' and usulan_no='$row_dos[no_usulan]'")->result_array();
			...
			$kum_baru_b_02=0;
			$jumlah_b_02=0;
			$sql_b_02=$this->db->query("SELECT NO,usulan_no,SUM(kum_usulan_lama)  AS kum_lama_b_02,SUM(kum_usulan_baru) AS kum_usulan_baru FROM usulan_dupaks WHERE usulan_no='$row_dos['no_usulan']' AND 
			dupak_no IN ('B0002','B0001','B0003','B0037','B0004','B0025','B0026','B0006','B0005','B0007','B0024','B0038') ")->result_array();
		  ...
		  <tr>
			<td colspan="2" rowspan="2" bgcolor="#CCCCCC">&nbsp;Jumlah Usul Angka Kredit</td>
		  ...
		  <tr>
			<td bgcolor="#CCCCCC"  align="center"><?=$da_bid_a1_lama?></td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC" align="center"><?=$da_bid_a1_lama?></td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC" align="center"><?=$da_bid_a1_lama?></td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC" align="center"><?=$da_bid_c_lama?></td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC" align="center"><?=$da_bid_d_lama?></td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<?php
			$jml_usul_ak_lama=0;
			$jml_usul_ak_lama=$da_bid_a1_lama+$da_bid_a1_lama+$da_bid_a1_lama+$da_bid_c_lama+$da_bid_d_lama;
			
			if($jml_usul_ak_lama==0)
			{$ju_ak_lama='';}else{$ju_ak_lama=$jml_usul_ak_lama;}
			?>
			<td bgcolor="#CCCCCC" align="center"><?=$ju_ak_lama?></td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
		  </tr>
		  <tr>
			<td colspan="2" rowspan="2">&nbsp;Kelebihan AK Yang Lalu</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		  ...
		  <tr>
			<td colspan="2" rowspan="2" bgcolor="#CCCCCC">&nbsp;Jumlah AK Seluruhnya</td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
			<td bgcolor="#CCCCCC">&nbsp;</td>
		  ...
		  <tr>
			<td colspan="2" rowspan="2">&nbsp;Jml. AK yang Seharusnya</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
