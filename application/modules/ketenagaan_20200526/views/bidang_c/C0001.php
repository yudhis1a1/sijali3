		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>ketenagaan/usulan_dupak_c/hapus_C0001/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/C0001/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>ketenagaan/usulan_dupak_c/tambah_C0001/C0001/<?= $kum ?>" role="form" enctype="multipart/form-data">
