		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>ketenagaan/usulan_dupak_d/hapus_D0014/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/D0021/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>ketenagaan/usulan_dupak_d/tambah_D0014/D0021/<?= $kum ?>" role="form" enctype="multipart/form-data">
