...
class Usulan_dupak extends MX_Controller
{
	...
	$q1=$this->db->query("SELECT kunci,usulan_no,kum_penilai,kum_penilai_keterangan,no,`uraian`,`semester`,`tahun_akademik`,`tahun_akademik`+1 AS thn_akademik_baru,`tgl`,`satuan_hasil`,angka_kredit,`jumlah_volume`,(sks*jumlah_volume) AS total_sks,`kum_usulan`,`keterangan`,url,url_index,berkas FROM  `usulan_dupak_details` WHERE usulan_no = '$id' AND `dupak_no` = '$no'")->row();	
