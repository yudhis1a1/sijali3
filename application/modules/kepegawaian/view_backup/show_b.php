...
<a href="<?= base_url()?>kepegawaian/kepegawaian/print_bidangb/<?php echo $no; ?>" target="_blank" class="btn btn-success fa fa-print"> BIDANG B</a>
...
?>
  <tr class="text-center">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>kepegawaian/usulan_dupak_b/dupak/B0002/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20" target='_BLANK'><i class="fa fa-search"></i></a>
...
?>
  <tr class="text-center">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>kepegawaian/usulan_dupak_b/dupak/B0004/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20" target='_BLANK'><i class="fa fa-search"></i></a>
