 ...
 <div class="row">
              ...
              <div class="col-md-12">
                ...
                <table  class="cust-print-table2 cust-table2-bordered text-center">
                  <tr><th><img src="<?= base_url()?>assets/images/logo.png" height="100px;"><br/><br/></tr></th>
                  <tr><th>KEPUTUSAN MENTERI RISET, TEKNOLOGI, DAN PENDIDIKAN TINGGI<br>REPUBLIK INDONESIA</tr></th>
                 </table 
                </center>
              </div>
            </div>  
                  ...
                  <tbody>
                    ...
                    <tr class="text-center btop">
                      <td colspan="9" class="text-center">
                        ...
                        MENTERI RISET, TEKNOLOGI, DAN PENDIDIKAN TINGGI<br/><br/>
                    ...
                    <tr class="bsmall">
                      ...
                      <ol type="a">
                      <li>
                      bahwa sebagai pelaksanaan dari Pasal 26 Peraturan Menteri Pendayagunaan Aparatur Negara Dan Reformasi Birokrasi Nomor 17 Tahun 2013, 
                      sebagaimana telah diubah dengan Keputusan Menteri Pendayagunaan Aparatur Negara Dan Reformasi Birokrasi Nomor 46 Tahun 2013, 
                      dan Peraturan Bersama Menteri Pendidikan dan Kebudayaan dan Kepala Badan Kepegawaian Negara Nomor 4/VIII/PB/2014 dan 
                      Nomor 24 Tahun 2014 tentang Ketentuan Pelaksanaan Peraturan Menteri Pendayagunaan Aparatur Negara Dan Reformasi Birokrasi 
                      Nomor 17 Tahun 2013 tentang Jabatan Fungsional Dosen dan Angka Kreditnya, sebagaimana telah diubah dengan Keputusan 
                      Menteri Pendayagunaan Aparatur Negara Dan Reformasi Birokrasi Nomor 46 Tahun 2013 perlu untuk menaikkan jabatan Dosen, 
                      Saudara/i <?php echo $data_dasar->gelar_depan.''.$data_dasar->nama.', '.$data_dasar->gelar_belakang; ?>; 
                      </li>
                      <li>
                      bahwa pengangkatan tersebut berdasarkan persetujuan dari Kepala LLDIKTI Wilayah III D.K.I Jakarta  
                      Nomor B/1654/L3/KK.01.00/2019 tanggal 30 Agustus 2019;
                      </li>
                      <li>
                      surat Pengantar Kepala Bagian Sumber Daya Perguruan TInggi LLDIKTI Wilayah III D.K.I Jakarta 
                      Nomor B/1020/L3.4.1/K.K.01.00/2019 tanggal 2 September 2019.
                      </li>
                      </ol>
                      </th>
                    </tr>
                    <tr class="bsmall">
                      ...
                      <li>
                      Peraturan Pemerintah Nomor 9 Tahun 2003, jo Nomor 63 Tahun 2009; </li>
                      <li>
                      ...
                      <li>
                      Keputusan Menteri Riset, Teknologi, dan Pendidikan Tinggi Nomor 389/M/KPT.KP/2018.
                      </li>
                      </ol>
                      </th>
                    </tr>
                    ...
                    <tr class="bsmall">
                      ...
                      <th class="text-right">:</th>
                      <th colspan="4" class="text-justify">
                      Terhitung mulai tanggal 1 September 2019 mengangkat :<br/>
                      N  a  m  a&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;: <?php echo $data_dasar->gelar_depan.''.$data_dasar->nama.', '.$data_dasar->gelar_belakang; ?><br/>
                      N I D N&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;:<?php echo ' '.$data_dasar->nidn; ?><br/>
                      Pangkat/gol. Ruang/TMT	: --<br/>
                      Unit Kerja&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;: LLDIKTI Wilayah III D.K.I Jakarta pada <?php echo $data_dasar->nama_instansi; ?><br/>
                      dalam jabatan <?php echo $data_dasar->nama_jabatans; ?> dengan angka kredit sebesar <?php echo $data_dasar->kum; ?> (<?php echo $terbilang; ?>)<br/>
                    </th>
                    </tr>
                    <tr class="bsmall">
                ...
                <table width="100% ">
                    <tr>
                      ...
                      <td colspan="4" style="vertical-align: top; border-left: none; border-right: none;">
                        ...
                        <br>Pada Tanggal&emsp;&emsp;: <?=$tgl_penatapan?>
                    ...
                    <tr>
                      <td colspan="9" style="border-left: none; border-right: none; border-bottom: none;">
                        Tembusan:
                        <br>1.	Sekretaris Jenderal Kementerian Riset, Teknologi, dan Pendidikan Tinggi di Jakarta;
                        <br>2.	Kepala Biro Sumber Daya Manusia Kementerian Riset, Teknologi, dan Pendidikan Tinggi di Jakarta;
                        <br>3.	Kepala Badan Kepegawaian Negara;
                        <br>4.	Kepala Kantor Pelayanan Perbendaharaan Negara di Jakarta;
                        <br>5.	Rektor Universitas Bunda Mulia di Jakarta.
