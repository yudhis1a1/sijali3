 ...
 <div class="row">
              ...
              <div class="col-md-12">
                ...
                <table  class="cust-print-table2 cust-table2-bordered text-center">
                  <tr><th><img src="<?= base_url()?>assets/images/logo3.png" height="100px;"><br/><br/></tr></th>
                 ...
                 <table  class="cust-print-table2 cust-table2-bordered">
                  ...
                  <tbody>
                    ...
                    <tr class="bsmall">
                      ...
                      <ol type="a">
                      <li>
                      bahwa sebagai pelaksanaan dari Pasal 24 Peraturan Menteri Pendayagunaan Aparatur Negara Dan Reformasi Birokrasi Nomor 17 Tahun 2013, 
                      ...
                      perlu untuk mengangkat Saudara/i <?php echo $data_dasar->gelar_depan.''.$data_dasar->nama.', '.$data_dasar->gelar_belakang; ?> dalam jabatan Akademik Dosen;
                      </li>
                      <li>
                      bahwa pengangkatan tersebut berdasarkan persetujuan dari Kepala LLDIKTI Wilayah III D.K.I Jakarta  
                      Nomor <?php echo $data_dasar->tmt_no; ?> tanggal <?php echo $tmt_tgl; ?>;
                      </li>
                    ...
                    <tr class="bsmall">
                      ...
                      <th class="text-right">:</th>
                      <th colspan="4" class="text-justify">
                      Terhitung mulai tanggal  <input type="text" name="sk_tmt" class="form-control" id="datepicker-autoclose2" placeholder="yyyy-mm-dd"  value="<?=$data_dasar->sk_tmt?>" style="width: 250px;" required="required">
                                       mengangkat :<br/>
