	...
	<div class="card-body">
        ...
        <table border="1" class="ui celled table" width="100%">
				...
				<tbody>
				  ...
				  <input type="hidden" class="form-control" value="A0002" name="bidang" readonly>
		...
		<table border="1" class="ui celled table" width="100%">
			...
			<tbody>
				<tr class="text-center">
					...
					<td><?=$q1->keterangan?><br><a href="<?= base_url()?>kepegawaian/usulan_dupak/download_bidanga/<?=$q1->berkas?>" class="btn  btn-success" ><i class="fa  fa-cloud-download"></i>[PDF]</a>
					<td>
					<?php if($usulan_status_id<>'1' && $usulan_status_id<>'2'){}else{ ?>
					<a href="<?= base_url()?>kepegawaian/usulan_dupak/hapus_ijazah/<?=$q1->no?>/<?=$q1->usulan_no?>/<?=$q1->berkas?>/A0002" class="btn btn-danger tombol-hapus" >
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>kepegawaian/usulan_dupak/tambah_a0001/A0002/<?= $dupak ?>" role="form" enctype="multipart/form-data">
