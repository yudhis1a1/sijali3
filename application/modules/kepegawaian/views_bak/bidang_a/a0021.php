...
<div class="row">
	...
	<div class="card-body">
        ...
        <table border="1" class="ui celled table" width="100%">
			...
			<?php if($usulan_status_id=='3'){ ?>
				  ...
				  <input type="hidden" class="form-control" value="A0021" name="bidang" readonly>
	...
	<div class="card-body">
		...
		<tr style="background-color: #e4e4e4; font-weight: bold;">
			...
			<a href="<?= base_url()?>kepegawaian/usulan_dupak/hapus_a0017/<?=$row_thn['NO']?>/<?=$row_thn['usulan_no']?>/<?=$row_thn['berkas']?>/<?=$row_thn['semester']?>/<?=$row_thn['tahun_akademik']?>/A0021/<?=$kum?>" class="btn btn-danger tombol-hapus"> Hapus
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>kepegawaian/usulan_dupak/tambah_a0017/A0021" role="form" enctype="multipart/form-data">
		<div class="modal-body">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
							...
							<br><input type="hidden" name="no_usulan" value="<?=$q_dupak->usulan_no?>">
						</div>
                    </div>
                  </div>
				  <div class="col-md-4">
			...
			<input type="hidden" id="kali" name="kali" value="5">
		</form>
