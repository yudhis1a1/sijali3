...
<div class="row">
	...
	<div class="card-body">
	  	<div class="tile">
			...
			Di lingkungan Perguruan Tinggi sebagai Ketua
		</div>
    </div>
	</div>
	</div>
	...
	<div class="card-body">
        ...
        <table border="1" class="ui celled table" width="100%">
				...
				<tbody>
				  ...
				  <input type="hidden" class="form-control" value="D0018" name="bidang" readonly>
		...
		<table border="1" class="ui celled table" width="100%">
			...
			<?php foreach($q3->result() as $row){?>
				<tr class="text-center">
					...
					<a href="<?= base_url()?>kepegawaian/usulan_dupak_d/hapus_D0014/<?=$row->no?>/<?=$row->usulan_no?>/<?=$row->berkas?>/D0018/<?=$kum?>" class="btn btn-danger tombol-hapus">
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg">
		...
		<form method="post" action="<?= base_url()?>kepegawaian/usulan_dupak_d/tambah_D0014/D0018/<?= $kum ?>" role="form" enctype="multipart/form-data">
