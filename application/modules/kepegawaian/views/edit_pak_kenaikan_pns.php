...
?>
 ...
 <div class="row">
        ...
        AND b.`bidang_ilmu_kode`=g.`kode`")->row();
					...
					$gel_depan=trim($data_dasar->gelar_depan);
...
$tgl_terhitung= $tgl_tmt;
              ...
              <div class="col-md-12">
				...
				<?php	 }
					  ?>
                        ...
                        <input type="hidden" name="usulan_status_id" value="<?=$data_dasar->usulan_status_id?> " style="width: 250px;"  required="required"><br/></h3>
                       TENTANG<br/>
				...
				<?php	 }
					...
					<br/>
                    <tr class="bsmall">
                      <th class="text-left" style="width: 100px;font-family:times new roman;">Menimbang</th>
                      <th class="text-right" >:</th>
                      <th colspan="7" class="text-justify">
                      <ol type="a">
                     <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                     bahwa sebagai pelaksanaan dari Pasal 26 Peraturan Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Nomor 17 Tahun 2013, sebagaimana telah diubah dengan Peraturan Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Nomor 46 Tahun 2013 dan Peraturan Bersama Menteri Pendidikan dan Kebudayaan  dan Kepala Badan Kepegawaian Negara Nomor 4/VIII/PB/2014 dan Nomor 24 Tahun 2014 tentang Ketentuan Pelaksanaan Peraturan Menteri Pendayagunaan  Aparatur Negara dan Reformasi  Birokrasi  Nomor  17  Tahun  2013  tentang  Jabatan  Fungsional  Dosen  dan Angka Kreditnya, sebagaimana  telah diubah dengan Peraturan Menteri Pendayagunaan Aparatur  Negara  dan  Reformasi  Birokrasi  Republik  Indonesia  Nomor  46 Tahun  2013 perlu untuk mengangkat/menaikkan jabatan akademik Dosen, Saudara <?php echo $gelar_depan.''.ucwords(strtolower($data_dasar->nama)).', '.$data_dasar->gelar_belakang; ?>;</li>
                     <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                      bahwa pengangkatan tersebut berdasarkan persetujuan dari Kepala LLDIKTI Wilayah III Nomor<input type="text" name="tmt_no"  value="<?=$data_dasar->tmt_no?>" style="width: 250px;" minlength="5" required="required"> tanggal <input type="text" name="tmt_akhir"  class="date-picker"  id="datepicker-autoclose3" placeholder="yyyy-mm-dd"  value="<?=$data_dasar->masa_penilaian_akhir?>" style="width: 250px;" required="required">
                      </li>
					   <?php
 ...
 <?php	 } }}
                    ...
                    <tr class="bsmall">
                      ...
                      <ol type="1">
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
					            Undang-Undang RI : a. Nomor 14 Tahun 2005; b. Nomor 12 Tahun 2012; c. Nomor 5 Tahun 2014; </li>
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                     Peraturan Pemerintah : a. Nomor 37 Tahun 2009; b. Nomor 16 Tahun 1994 jo. Nomor 40 Tahun 2010;            c. Nomor 9 Tahun 2003 jo. Nomor 63 Tahun 2009; d. Nomor 11 Tahun 2017 jo. Nomor 17 Tahun 2020;
                       </li>
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                    <?php
					...
					<?php	 }
					  ?></li>
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                      Peraturan Menteri Riset, Teknologi, dan Pendidikan Tinggi Nomor 26 Tahun 2015 jo. Nomor 2 Tahun 2016;
                      </li>
                       <?php
                   ...
                   <tr class="text-center btop">
                      <td colspan="4" class="text-center" style="font-weight: bold;font-size:22px;font-family:times new roman;line-height:1.2;">
                       M E M U T U S K A N
                      </td>
                    </tr>
				   ...
				   ?>
					   <table border="0">
						...
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;">N  a  m  a</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;"><?php echo $data_dasar->gelar_depan.''.ucwords(strtolower($data_dasar->nama)).', '.$data_dasar->gelar_belakang; ?></td></tr>
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;">NIP / N I D N</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;"><input type="text" name="nip"  value="<?=$data_dasar->nip1?>" style="width: 250px;" minlength="5" required="required" placeholder='NIP PNS'><?php echo "/".$data_dasar->nidn; ?></td></tr>
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;width:225px;">Pangkat/gol. Ruang/TMT</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;">
						<select name="pangkat">
						<?php
						
						foreach($pangkat as $gol){
						
						if ($data_dasar->pangkat==$gol->nama.' / '.$gol->kode_gol)
						{
							$select='Selected';
						}else{
							$select='';
						...
						<option value='<?=$gol->nama.' / '.$gol->kode_gol?>' <?=$select?>><?=$gol->nama.' / '.$gol->kode_gol?></option>
						...
						<input type="text" name="tmt_pangkat" class="form-control" id="datepicker-autoclose4" placeholder="yyyy-mm-dd"  value="<?=$data_dasar->tmt_pangkat?>" style="width: 250px;" required="required">
						</td></tr>
            ...
            <tr><td colspan="3" style="font-family:times new roman;font-size:21px;line-height:1.1;"><br/>dari jabatan dosen jenjang  <?php echo $jadlama; ?> ke dalam jabatan Dosen jenjang <?php echo $jabusul; ?> dengan angka kredit sebesar <?php echo $kumusul; ?> (<?php echo $terbilangusul; ?>);</td></tr>
         </tbody></table>			
                    ...
                    <tr class="bsmall">
                      ...
                      <th class="text-right">:</th>
                      <th colspan="4" class="text-justify" style="font-family:times new roman;font-size:21px;line-height:1.2;">
                      kepada yang bersangkutan diberi gaji pokok menurut pangkat/golongan ruang sebesar Rp. <input type="text" name="gaji"  value="<?=$data_dasar->gaji?>" style="width: 250px;" minlength="5" required="required" placeholder='isi hanya dengan angka'> sebulan berdasarkan Peraturan Pemerintah Nomor 30 Tahun 2015 dan tunjangan jabatan dosen sebesar Rp. <input type="text" name="tunjangan"  value="<?=$data_dasar->tunjangan?>" style="width: 250px;" minlength="5" required="required" placeholder='isi hanya dengan angka'> sebulan menurut Peraturan Presiden Nomor 65 Tahun 2007.</th>
                    </tr>
                    <tr class="bsmall">
                    ...
                    <tr class="bsmall">
                      <th class="text-left"style="width: 100px;font-family:times new roman;font-size:22px;line-height:1.2;">Keempat</th>
                      <th class="text-right">:</th>
                      <th colspan="4" class="text-justify" style="font-family:times new roman;font-size:21px;line-height:1.2;">
                    ...
                    <tr class="bsmall">
					 ...
					 ?>
					  <br>1.	Sekretaris Jenderal Kemendikbudristek;
                        <br>2.	Kepala Biro Sumber Daya Manusia Kemendikbudristek;
                      <br>3. Kepala Badan Kepegawaian Negara;
                      <br>4. Kepala KPPN Jakarta;
                      <br>5. Kepala LLDIKTI Wilayah III;
                      <br>6.	<?php echo $pimpinan.' '.$data_dasar->nama_instansi; ?>.

					 
					  <?php }else{
					?>	 
						  <br>1.	Sekretaris Jenderal Kemdikbud;
                        <br>2.	Kepala Biro Sumber Daya Manusia Kemdikbud;
                      <br>3. Kepala Badan Kepegawaian Negara;
                      <br>4. Kepala KPPN Jakarta;
                      <br>5. Kepala LLDIKTI Wilayah III;
                      <br>6.	<?php echo $pimpinan.' '.$data_dasar->nama_instansi; ?>.
