	    ...
	    $yx=date("Y",strtotime($tgltmt));
          ...
          <table class="cust-print-table2 cust-table2-bordered">
            ...
            <tbody>
              ...
              <tr class="bsmall">
                ...
                <th colspan="7" class="text-justify">
                  <ol type="a">
                    ...
                    <?php
                    $tgl_revisi_pak = $resume->tgl_revisi_pak;

                    if ($tgl_revisi_pak <> '0000-00-00') {
                    } else {
              ...
              <tr class="text-center btop">
                <td colspan="7" class="text-center" style="font-weight: bold;font-size:22px;font-family:times new roman;line-height:1.1;">
                  M E M U T U S K A N
                </td>
              </tr>
                  ...
                  <table border="0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="font-family:times new roman;font-size:21px;line-height:1.1;"><?php echo $gelar_depan . '' . ucwords(strtolower($data_dasar->nama)) . ', ' . $data_dasar->gelar_belakang; ?></td>
                      </tr>
                      <tr>
              ...
              <tr class="bsmall">
                ...
                <th class="text-right">:</th>
                <th colspan="7" class="text-justify" style="font-family:times new roman;font-size:21px;line-height:1.1;">
          ...
          <table width="130%">
            <tr class="bsmall">
              <th colspan="98" style="vertical-align: top; border-left: none; border-right: none; width: 50%;font-family:times new roman;font-size:21px;line-height:1.1;">
