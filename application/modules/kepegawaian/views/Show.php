...
<div class="row page-titles">
	...
	<div class="col-md-7 align-self-center text-right">
		<div class="d-flex justify-content-end align-items-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="javascript:void(0)">Sub HKT</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
									...
									<?php if ($usulan_status_id == '8' && $v_usulans->user_penilai_keputusan == 'DITERIMA') {  ?>
									<li class="nav-item"> <a class="nav-link" data-toggle="tab" id="nav_pak1" href="#pak1" role="tab"><span class="hidden-sm-up"><i class="ti-ruler-pencil "></i></span> <span class="hidden-xs-down">PAK</span></a> </li>
                                    ...
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" id="nav_ski"  href="#ski" role="tab"><span class="hidden-sm-up"><i class="ti-ruler-pencil "></i></span> <span class="hidden-xs-down">Inpasing</span></a> </li>
                                    <?php } ?>
	...
	<div class="form-group m-t-40 row">
		...
		<select name="kaprodi_jabatan" class="select2 m-b-10 select2-multiple" style="width: 100%"  id="kaprodi_jabatan" disabled>
			...
			<?php } ?>
									...
									<div class="tab-pane p-20" id="pak1" role="tabpanel"></div>   
                                    <div class="tab-pane p-20" id="pak" role="tabpanel"></div> 
										<div class="tab-pane p-20" id="ski" role="tabpanel"></div>                                 
...
$(function() {
      $url ="<?php echo base_url('kepegawaian/kepegawaian/show_inpasing/'.$no_usulan); ?>";
    $('#nav_ski').click(function() {
        $('#ski').load($url);
        $(this).removeClass('active'); 
    });
})
                  ...
                  ?>
                      ...
                      <option value="9">Proses Selesai</option>
					   ...
					   if($data_dasar->usulan_status_id == '9' ){
						?>   
						   <option value="6">Proses Operator Sub PTK</option>
                      <option value="8">Proses Operator Sub HKT</option>
					  <option value="9" selected>Proses Selesai</option>
						   
					<?php   }
                       
                       
                       if($data_dasar->usulan_status_id == '3' || $data_dasar->usulan_status_id == '4' ){ ?>
                      <option <?php if ($data_dasar->usulan_status_id == '4'  ) echo 'selected' ; ?> value="4" >Proses Approval Tim Penilai</option>
