              ...
              <div class="col-md-12">
				...
				<?php	 }
			 	 ...
			 	 ?>
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                      <?php
					  if (date("Y", strtotime($sk_tgl))<2021){
					 ?>
...
<?php	 } }
				   ...
				   ?>
					   <table border="0">
						...
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;">NIP / N I D N</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;"><?php echo $data_dasar->nip1."/".$data_dasar->nidn; ?></td></tr>
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;width:225px;">Pangkat/gol. Ruang/TMT</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;"><?php echo $data_dasar->pangkat." / ".$tmt_pangkat; ?></td></tr>
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;">Unit Kerja</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;">LLDIKTI Wilayah III ditugaskan pada <?php echo ' '.$data_dasar->nama_instansi; ?><br/></td></tr>
            <tr><td colspan="3" style="font-family:times new roman;font-size:21px;line-height:1.1;"><br/>dari jabatan dosen jenjang  <?php echo $jadlama; ?> ke dalam jabatan Dosen jenjang <?php echo $jabusul; ?> dengan angka kredit sebesar <?php echo $kumusul; ?> (<?php echo $terbilangusul; ?>);</td></tr>
					...
					<tr class="bsmall">
                      ...
                      kepada yang bersangkutan diberi gaji pokok menurut pangkat/golongan ruang sebesar Rp. <?php echo number_format($data_dasar->gaji,0,".","."); ?> (<?php echo $terbilanggaji," rupiah"; ?>) sebulan berdasarkan Peraturan Pemerintah Nomor 15 Tahun 2019 dan tunjangan jabatan dosen sebesar Rp. <?php echo number_format($data_dasar->tunjangan,0,".","."); ?> (<?php echo $terbilangtun." rupiah"; ?>) sebulan menurut Peraturan Presiden Nomor 65 Tahun 2007.</th>
                    </tr>
                    <tr class="bsmall">
                ...
                <table width="130%">
                    <tr class="bsmall">
					 ...
					 ?>
                      ...
                      <br>6.	<?php echo $pimpinan.' '.$data_dasar->nama_instansi; ?> di Jakarta.
