...
<?php	 } }
				   ...
				   ?>
					   <table border="0">
						...
						<tr><td style="font-family:times new roman;font-size:21px;line-height:1.2;">NIP / N I D N</td><td>&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.2;"><?php echo $data_dasar->nip."/".$data_dasar->nidn; ?></td></tr>
  ...
  $tgl_p_akhir= $tgl_terakhir;
           ...
           ?>
            ...
            <br>2.	Kepala Biro Sumber Daya Manusia Kemendikbudristek;
                      ...
                      <br>5.	<?php echo $pimpinan.' '.$data_dasar->nama_instansi; ?> di Jakarta.
                      					  <?php }else{
					?>	 
