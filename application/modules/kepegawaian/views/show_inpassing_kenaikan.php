...
$tgl_terhitung_inp= $tgl_tmt_inp;
            ...
            DENGAN RAHMAT TUHAN YANG MAHA ESA<br/>
             KEPUTUSAN MENTERI PENDIDIKAN, KEBUDAYAAN, RISET, DAN TEKNOLOGI<br/><br/>
                    ...
                    <th class="text-left" style="width: 100px;font-family:times new roman;font-size:22px;line-height:1.1;">Memperhatikan</th>
                      ...
                      Surat <?php echo $pimpinan; ?> <?php echo $data_dasar->nama_instansi; ?> Nomor <?php echo $data_dasar->nosurat_rektor; ?> tanggal <?php echo gfDateStandart($data_dasar->tgl_surat_rektor); ?>.
                   ...
                   $jenjang_id=$data_dasar->jenjang_id;
            ...
            <tr><td style="font-family:times new roman;font-size:21px;line-height:1.1;">Pangkat Penyetaraan, golongan ruang, tmt</td><td>&ensp;&ensp;&ensp;&ensp;:&ensp;</td><td style="font-family:times new roman;font-size:21px;line-height:1.1;"><?php echo $gol_awal; ?>, <?php echo $gol_kode; ?>, <?php echo gfDateStandart($data_dasar->tmt_golongan_awal); ?></td></tr>
            ...
            <tr><td colspan="3" style="font-family:times new roman;font-size:21px;line-height:1.1;"><br/>Dinaikan pangkat penyetaraanya menjadi <?php echo $getgolongan->nama_gol; ?>, golongan ruang <?php echo $getgolongan->kode_gol;?> dengan masa kerja <?=$y_masa_kerja?> Tahun <?=$m_masa_kerja?> Bulan</td></tr>
                   ...
                   <tr class="bsmall">
                    ...
                    <tr class="bsmall">
                      <th colspan="6"  class="text-left"style="width: 100px;font-family:times new roman;font-size:22px;line-height:1.1;"><br>Keputusan ini diberikan kepada yang berkepentingan untuk dipergunakan sebagaimana mestinya.</th>
                ...
                <table width="130%">
                    <tr class="bsmall">
                     ...
                     Ditetapkan di Jakarta  
					  <br>Pada tanggal <?php $tglskin=gfDateStandart($tglsk_inp); echo $tglskin; ?>
