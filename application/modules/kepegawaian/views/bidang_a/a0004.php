...
<div class="row">
	...
	<div class="card-body">
        ...
        <table border="1" class="ui celled table" width="100%">
				...
				<tbody>
				  ...
				  <input type="hidden" class="form-control" value="A0004" name="bidang" readonly>
	...
	<div class="card-body">
		...
		<tr style="background-color: #e4e4e4;">
			...
			<a href="<?= base_url()?>kepegawaian/usulan_dupak/hapus_a0004/<?=$row_thn['NO']?>/<?=$row_thn['usulan_no']?>/<?=$row_thn['berkas']?>/<?=$row_thn['semester']?>/<?=$row_thn['tahun_akademik']?>" class="btn tombol-hapus btn-danger" >Hapus
...
<div class="modal fade"  aria-labelledby="myLargeModalLabel" id="tambah" >
	<div class="modal-dialog modal-lg text-justify">
		...
		<form method="post" action="<?= base_url()?>kepegawaian/usulan_dupak/tambah_a0004/A0004/200" role="form" enctype="multipart/form-data">
