...
$tgl_terhitung= $tgl_tmt;
 ...
 <?php	 } }}
                    ...
                    <tr class="bsmall">
                      ...
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                      Peraturan Pemerintah : a. Nomor 37 Tahun 2009; b. Nomor 16 Tahun 1994 jo. Nomor 40 Tahun 2010; c. Nomor 9 Tahun 2003 jo. Nomor 63 Tahun 2009; d. Peraturan Pemerintah Nomor 11 Tahun 2017;
                      </li>
                      <li style="font-family:times new roman;font-size:21px;line-height:1.2;">
                     <?php
                ...
                <table width="130%">
					...
					<br><br> <br><br><br>
					 ...
					 ?>
                      ...
                      <br>5.	<?php echo $pimpinan.' '.$data_dasar->nama_instansi; ?>.
					...
					?>	 
                     ...
                     <br>KEPALA LLDIKTI WILAYAH III,<br><br><br>
                         <?php
					    if ((date("m", strtotime($tgltmtdiff))>=2)  && (date("Y", strtotime($tgltmtdiff))>=2022)){
					  ?>
