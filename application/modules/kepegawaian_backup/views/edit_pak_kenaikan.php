                 ...
                 <table  class="cust-print-table2 cust-table2-bordered">
                  ...
                  <tbody>
                    ...
                    <tr class="bsmall">
                      ...
                      <th class="text-right">:</th>
                      <th colspan="4" class="text-justify">
                      Terhitung mulai tanggal <input type="text" name="sk_tmt" class="form-control" id="datepicker-autoclose2" placeholder="yyyy-mm-dd"  value="<?=$data_dasar->sk_tmt?>" style="width: 250px;" required="required"> menaikkan jabatan Dosen :<br/>
                      ...
                      dari jabatan dosen jenjang  <?php echo $jadlama; ?> ke dalam jabatan Dosen jenjang <?php echo $jabusul; ?> dengan angka kredit sebesar  ()
                     </br>
                     </th>
                    </tr>
                    <tr class="bsmall">
