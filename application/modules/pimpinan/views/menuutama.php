...
?>
    <li>
        <a class="waves-effect waves-dark" href="<?php echo base_url(); ?>pimpinan/pimpinan/tampil_usulan" aria-expanded="false"><i class="fa fa-lg fa-fw fa-qrcode"></i><span class="hide-menu">Usulan JFA</span></a>
    </li>
<?php
}
?>
