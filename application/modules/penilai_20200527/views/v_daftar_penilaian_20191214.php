                         ...
                         <div class="card-body">                              
                                ...
                                <form class="form">
                                    ...
                                    <!-- <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text"  id="bidang_ilmu_kode" value="<?php echo "$bidil_jad->kode - $bidil_jad->nama"; ?> " readonly>
                                        </div>
                                    </div> -->
                                    <div class="form-group m-t-40 row">
...
$(function() {
      $url ="<?php echo base_url('penilai/penilai/show_matakul/'.$no_usulan); ?>";
...
$(function() {
      $urlriwayat ="<?php echo base_url('penilai/penilai/show_pendidikan/'.$no_usulan); ?>";
...
$(function() {
      $urlbidang ="<?php echo base_url('penilai/penilai/bidangA/'); ?>";
...
$(function() {
      $urlbidang_b ="<?php echo base_url('penilai/penilai/bidangB/'); ?>";
...
$(function() {
      $urlbidang_c ="<?php echo base_url('penilai/penilai/bidangC/'); ?>";
...
$(function() {
      $urlbidang_d ="<?php echo base_url('penilai/penilai/bidangD/'); ?>";
