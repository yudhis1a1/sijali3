    ...
    <table class="table color-table info-table table-bordered">
		...
		?>
		  <tr class="text-center">
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0002/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
		...
		?>
		  <tr class="text-center">
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0004/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
		...
		?>
		  <tr class="text-center">
			...
			<?php
		$sql_b0022="select *from usulan_dupaks where dupak_no='b0023' and usulan_no='$no'";
