...
<div class="row">
	...
	<div class="card-body">
		...
		<form method="post" action="<?= base_url()?>penilai/penilai_dupak/update_A0004/A0017" role="form" enctype="multipart/form-data">
		<table border="1" class="ui celled table" width="100%">
		<?php 
		$q_thn="SELECT
				  usulan_no,
		...
		<tr style="background-color: #e4e4e4;">
			...
			<td>Bukti Fisik : <a href="<?= base_url()?>usulan/usulan_dupak/download_bidanga/<?=$row_thn['berkas']?>" target="blank" class="btn  btn-success" ><i class="fa  fa-cloud-download"></i>[PDF]</a>
			</td>
			<?php
			$q_ak="SELECT
