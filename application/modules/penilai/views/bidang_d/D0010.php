		...
		<table border="1" class="ui celled table" width="100%">
			...
			<tbody>
				...
				<tr class="text-center">
					...
					<td><?=$row->keterangan?><br><a href="<?= base_url()?>usulan/usulan_dupak_c/download_bidangc/<?=$row->berkas?>" target="blank" class="btn  btn-success" ><i class="fa  fa-cloud-download"></i>[PDF]</a></td>
