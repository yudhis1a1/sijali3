...
?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item"> 
										<a class="nav-link active"  href="<?= base_url()?>penilai/penilai/bidangD/<?php echo $no; ?>" >
										<span class="hidden-sm-up">
											<i class="ti-agenda "></i>
										</span> 
	...
	<tr>
		<td>
		<center>
		<a href="<?= base_url()?>penilai/penilai_dupak_d/print_bidangd/<?php echo $no; ?>" target="_blank" class="btn btn-success fa fa-print"> BIDANG D</a>
    ...
    <table class="table color-table info-table table-bordered">
		...
		<tbody>
			...
			?>
			<?php
			  $cek_D0001="select *from usulan_dupak_details where dupak_no='D0001' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0001/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0002="select *from usulan_dupak_details where dupak_no='D0002' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0002/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0003="select *from usulan_dupak_details where dupak_no='D0003' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0003/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0004="select *from usulan_dupak_details where dupak_no='D0004' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0004/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			<?php
			  $cek_D0005="select *from usulan_dupak_details where dupak_no='D0005' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0005/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0006="select *from usulan_dupak_details where dupak_no='D0006' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0006/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0007="select *from usulan_dupak_details where dupak_no='D0007' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0007/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0008="select *from usulan_dupak_details where dupak_no='D0008' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0008/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0009="select *from usulan_dupak_details where dupak_no='D0009' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0009/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0010="select *from usulan_dupak_details where dupak_no='D0010' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0010/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0011="select *from usulan_dupak_details where dupak_no='D0011' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0011/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0012="select *from usulan_dupak_details where dupak_no='D0012' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0012/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0013="select *from usulan_dupak_details where dupak_no='D0013' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td rowspan="2" style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0013/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0014="select *from usulan_dupak_details where dupak_no='D0014' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0014/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0015="select *from usulan_dupak_details where dupak_no='D0015' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0015/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0016="select *from usulan_dupak_details where dupak_no='D0016' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0016/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0017="select *from usulan_dupak_details where dupak_no='D0017' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0017/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0018="select *from usulan_dupak_details where dupak_no='D0018' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0018/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0019="select *from usulan_dupak_details where dupak_no='D0019' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0019/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0020="select *from usulan_dupak_details where dupak_no='D0020' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0020/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0021="select *from usulan_dupak_details where dupak_no='D0021' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0021/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0022="select *from usulan_dupak_details where dupak_no='D0022' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0022/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0023="select *from usulan_dupak_details where dupak_no='D0023' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0023/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0024="select *from usulan_dupak_details where dupak_no='D0024' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0024/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0025="select *from usulan_dupak_details where dupak_no='D0025' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0025/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0026="select *from usulan_dupak_details where dupak_no='D0026' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0026/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0027="select *from usulan_dupak_details where dupak_no='D0027' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0027/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			</td>
			</tr>
			<?php
			...
			?>
			<?php
			  $cek_D0028="select *from usulan_dupak_details where dupak_no='D0028' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0028/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0029="select *from usulan_dupak_details where dupak_no='D0029' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0029/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0030="select *from usulan_dupak_details where dupak_no='D0030' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0030/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0031="select *from usulan_dupak_details where dupak_no='D0031' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0031/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0032="select *from usulan_dupak_details where dupak_no='D0032' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;">
				...
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0032/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0033="select *from usulan_dupak_details where dupak_no='D0033' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;"><?=$data_bid_d_D0033['kum_usulan_lama'];?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0033['kum_usulan_baru']?></td>
			<td style="vertical-align: middle;"><?= $jumlah_D0033 ;?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0033['kum_penilai_lama']?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0033['kum_penilai_baru']?></td>
			<td style="vertical-align: middle;"><?=$kum_nilai_D0033?></td>
			<td style="vertical-align: middle;">
				
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0033/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0034="select *from usulan_dupak_details where dupak_no='D0034' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td style="vertical-align: middle;"><?=$data_bid_d_D0034['kum_usulan_lama'];?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0034['kum_usulan_baru']?></td>
			<td style="vertical-align: middle;"><?= $jumlah_D0034 ;?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0034['kum_penilai_lama']?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0034['kum_penilai_baru']?></td>
			<td style="vertical-align: middle;"><?=$kum_nilai_D0034?></td>
			<td style="vertical-align: middle;">
				
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0034/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
			...
			?>
			<?php
			  $cek_D0035="select *from usulan_dupak_details where dupak_no='D0035' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
			...
			<td>3</td>
			<td colspan="3" class="text-left">Skala Regional/lokal</td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0035['kum_usulan_lama'];?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0035['kum_usulan_baru']?></td>
			<td style="vertical-align: middle;"><?= $jumlah_D0035 ;?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0035['kum_penilai_lama']?></td>
			<td style="vertical-align: middle;"><?=$data_bid_d_D0035['kum_penilai_baru']?></td>
			<td style="vertical-align: middle;"><?=$kum_nilai_D0035?></td>
			<td style="vertical-align: middle;">
				
				<a href="<?= base_url()?>penilai/penilai_dupak_d/dupak/D0035/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
