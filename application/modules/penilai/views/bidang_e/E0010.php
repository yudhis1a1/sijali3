		...
		<div class="card">
			<div class="card-body">
				<div class="tile">
					...
					<b>Membimbing Kegiatan Kemahasiswaan</b><br>
				</div>
...
?>
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<form method="post" action="<?= base_url() ?>penilai/penilai_dupak_e/update_E0002/<?= $q_dupak->dupak_no ?>" role="form" enctype="multipart/form-data">
						<table border="1" class="ui celled table" width="100%">
							<thead>
								<tr style="background-color: #e4e4e4; font-weight: bold;" class="text-center">
									<th>Semester</th>
								...
								<?php foreach ($q3->result() as $row) { ?>
									...
									<tr style="background-color: <?= $warna ?>; font-weight: bold;">
										...
										<td style="min-width: 50px">
											...
											<input class="largerCheckbox" type="checkbox" name="kum_penilai[]" value="<?= $row->angka_kredit ?>,<?= $row->no ?>" <?= $cek ?>>
