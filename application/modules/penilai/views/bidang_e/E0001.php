		...
		<div class="card">
			<div class="card-body">
				<div class="tile">
					...
					<b>Mendapatkan Hibah Penelitian Kompetitif (sebagai ketua)</b><br>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<form method="post" action="<?= base_url() ?>penilai/penilai_dupak_e/update_E0001/<?= $q_dupak->dupak_no ?>" role="form" enctype="multipart/form-data">
							...
							<?php foreach ($q3->result() as $row) { ?>
								...
								<tr style="background-color: <?= $warna ?>; font-weight: bold;">
									...
									<td style="min-width: 50px">
										...
										<input class="largerCheckbox" type="checkbox" name="kum_penilai[]" value="1,<?= $row->no ?>" <?= $cek ?>>
					...
					<tr class="text-center">
						...
						} else { ?><center><a href="<?= base_url() ?>penilai/penilai_dupak_e/hapus_E0001/<?= $q_dupak->dupak_no ?>/<?= $q_dupak->usulan_no ?>" class="btn btn-danger">RESET PENILAIAN</a>&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-success">SIMPAN PENILAIAN</button></center><?php } ?>
					</tr>
				</form>
			</div>
		</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body">
				<div class="tile">
					<a href="<?= base_url() ?>penilai/penilai/bidangE/<?= $no ?>" class="btn btn-success"><i class="fa fa-backward"></i> Kembali Ke Detail Usulan Dosen</a>
				</div>
			</div>
		</div>
	</div>
