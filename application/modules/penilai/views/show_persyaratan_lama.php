          ...
          <table class="table color-table info-table">
            ...
            <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="surat_pengantar" data-judul="Surat Pengantar dari Pimpinan PTS"></a>
                </td>
                <?php }?>
              ...
              <tr>
               ...
               <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sk_pengangkatan" data-judul="Fotocopy SK Pengangkatan sebagai Dosen Tetap Yayasan dilegalisir"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
               ...
               <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="ijasah_transkrip" data-judul="Fotocopy ljazah dan Transkrip S-1/D-4 , S-2 serta S-3 (bagi yang telah memiliki) dilegalisir"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="dupak" data-judul="Daftar Usul Penetapan Angka Kredit (DUPAK)"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sp_pengajaran" data-judul="Surat Pernyataan Melaksanakan Pendidikan dan Pengajaran (Bidang A), beserta data pendukungnya"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sp_penelitian" data-judul="Surat Pernyataan Melaksanakan Penelitian (Bidang B), beserta Karya llmiah yang asli"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sp_pengabdian" data-judul="Surat Pernyataan Melaksanakan Pengabdian Pada Masyarakat (Bidang C), beserta data pendukungnya"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sp_penunjang" data-judul="Surat Pernyataan Melaksanakan Penunjang Tri Dharma Perguruan Tinggi (Bidang D), beserta data pendukungnya"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="ba_senat" data-judul="Berita Acara Senat Fakultas bagi Universitas/Institut atau Senat Perguruan Tinggi bagi Sekolah Tinggi/Akademi dan Politeknik (Format Terlampir) + Daftar Hadir"></a>
                </td>
                <?php }?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="penilaian_kerja" data-judul="Nilai Prestasi Kerja dari Pimpinan PTS"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sp_karya_ilmiah" data-judul="Surat Pernyataan Keabsahan Karya llmiah yang ditandatangani Dosen ybs. (Format Terlampir)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="validasi_karya_ilmiah" data-judul="Lembar Pernyataan Pengesahan Hasil Validasi Karya Ilmiah yang ditandatangani oleh Pimpinan PTS (Format Terlampir)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="bukti_publikasi_online" data-judul="Bukti Online Penelitian yang dipublikasikan pada Portal Jurnal/Perguruan Tinggi/Portal Kopertis/Portal Garuda DIKTI"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sk_jad_inpassing" data-judul="Fotocopy SK Jabatan Akademik Dosen, SK PAK dan SK Pangkat/Inpassing Terakhir (bagi yang mengajukan Kenaikan Jabatan/Pangkat)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sk_tugas_belajar" data-judul="Fotocopy SK/Surat Izin Studi Lanjut dari Pimpinan PTS (bagi Dosen yang sedang melaksanakan/ menyelesaikan studi lanjut)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sk_aktif_kembali" data-judul="Fotocopy SK Pengaktifan Kembali (untuk dosen yang sudah menyelesaikan studi lanjut dengan status tugas belajar)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sk_dosen_pns" data-judul="Fotocopy SK Dosen PNS (bagi dosen PNS dpk.)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="sk_nip_baru" data-judul="Fotocopy Keputusan Kepala BKN tentang penetapan NIP Baru (bagi dosen PNS dpk.)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="spmj_spmt" data-judul="Fotocopy Surat Pernyataan Menduduki Jabatan (SPMJ) dan Surat Pernyataan Melaksanakan Tugas (SPMT)  (bagi dosen PNS dpk.)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="serdik" data-judul="Fotocopy Sertifikat Pendidik Legalisir (bagi yang telah memiliki)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="matkul" data-judul="Sebaran Mata Kuliah/Kurikulum Tempat Dosen Mengajar (Prodi/Homebase)"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                  <a href="#uploadModal" data-toggle="modal" data-nama="nidn" data-judul="Print Out NIDN dari laman forlap.ristekdikti.go.id"></a>
                </td>
                <?php } ?>
              </tr>
              <tr>
                ...
                <?php }else{ ?>
                <td class="text-center" style="width: 50px;" colspan="2">
                    <a href="#uploadModal" data-toggle="modal" data-nama="artikel" data-judul="Daftar Artikel Ilmiah (Format Terlampir)"></a>
                  </td>
                  <?php } ?>
                </tr>
            <tr>
              ...
              <!-- <tr>
                ...
                <td class="text-center" style="width: 50px;">
                  <a href="#uploadModal" data-toggle="modal" data-nama="penilaian_sejawat" data-judul="Hasil Penilaian Sejawat Sebidang Atau Peer Review Karya Ilmiah (terutama untuk kenaikan JFA Dosen Lektor Kepala dan Guru Besar"></a>
                </td>
              </tr> -->
            </tbody>
          </table>
