                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item"> 
										<a class="nav-link active"  href="<?= base_url()?>penilai/penilai/bidangB/<?php echo $no; ?>" >
										<span class="hidden-sm-up">
											<i class="ti-agenda "></i>
										</span> 
...
<!--<table  class="ui celled table">
	<tr>
		<td>
		<center>
		<a href="<?= base_url()?>penilai/penilai/print_bidangb/<?php echo $no; ?>" target="_blank" class="btn btn-success fa fa-print"> BIDANG B</a>
...
<tbody>
  ...
  <?php
	...
	?>
	 <?php
	  $cek_B0002="select *from usulan_dupak_details where dupak_no='B0002' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td><a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0002/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a></td>
  </tr>
  <?php
	...
	?>
	<?php
	  $cek_B0001="select *from usulan_dupak_details where dupak_no='B0001' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
			...
			<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0001/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0003="select *from usulan_dupak_details where dupak_no='B0003' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0003/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
   ...
   <?php
	...
	?>
	<?php
	  $cek_B0037="select *from usulan_dupak_details where dupak_no='B0037' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0037/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0004="select *from usulan_dupak_details where dupak_no='B0004' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td><a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0004/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a></td>
  </tr>
  <?php
	...
	?>
	<?php
	  $cek_B0025="select *from usulan_dupak_details where dupak_no='B0025' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
			...
			<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0025/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0026="select *from usulan_dupak_details where dupak_no='B0026' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0026/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0005="select *from usulan_dupak_details where dupak_no='B0005' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
			...
			<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0005/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0006="select *from usulan_dupak_details where dupak_no='B0006' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0006/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0007="select *from usulan_dupak_details where dupak_no='B0007' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0007/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0038="select *from usulan_dupak_details where dupak_no='B0038' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	<td>&nbsp;</td>
	<td colspan="4">6) Jurnal Nasional (Jurnal nasional di luar poin 5)	</td>
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0038/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0024="select *from usulan_dupak_details where dupak_no='B0024' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0024/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0035="select *from usulan_dupak_details where dupak_no='B0035' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0035/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0036="select *from usulan_dupak_details where dupak_no='B0036' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0036/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0034="select *from usulan_dupak_details where dupak_no='B0034' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0034/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0033="select *from usulan_dupak_details where dupak_no='B0033' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0033/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0031="select *from usulan_dupak_details where dupak_no='B0031' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0031/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0032="select *from usulan_dupak_details where dupak_no='B0032' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0032/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0029="select *from usulan_dupak_details where dupak_no='B0029' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0029/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0030="select *from usulan_dupak_details where dupak_no='B0030' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0030/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0027="select *from usulan_dupak_details where dupak_no='B0027' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0027/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0028="select *from usulan_dupak_details where dupak_no='B0028' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0028/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0011="select *from usulan_dupak_details where dupak_no='B0011' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0011/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0012="select *from usulan_dupak_details where dupak_no='B0012' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0012/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0013="select *from usulan_dupak_details where dupak_no='B0013' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0013/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0014="select *from usulan_dupak_details where dupak_no='B0014' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0014/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0015="select *from usulan_dupak_details where dupak_no='B0015' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0015/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
	...
	?>
	<?php
	  $cek_B0016="select *from usulan_dupak_details where dupak_no='B0016' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0016/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0017="select *from usulan_dupak_details where dupak_no='B0017' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0017/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0018="select *from usulan_dupak_details where dupak_no='B0018' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0018/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0019="select *from usulan_dupak_details where dupak_no='B0019' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0019/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0020="select *from usulan_dupak_details where dupak_no='B0020' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0020/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0021="select *from usulan_dupak_details where dupak_no='B0021' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0021/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <?php
	...
	?>
	<?php
	  $cek_B0022="select *from usulan_dupak_details where dupak_no='B0022' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0022/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
	...
	?>
	<?php
	  $cek_B0023="select *from usulan_dupak_details where dupak_no='B0023' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		...
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0023/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
		
	</td>
  </tr>
	<?php
	$sql_b0039="select *from usulan_dupaks where dupak_no='B0039' and usulan_no='$no'";
	...
	$kum_nilai_b0039=$data_bid_b_b0039['kum_penilai_lama']+$data_bid_b_b0039['kum_penilai_baru'];
	?>
	<?php
	  $cek_B0039="select *from usulan_dupak_details where dupak_no='B0039' AND usulan_no='$no' GROUP BY `kunci` ORDER BY kunci ASC";
	  $da_B0039=mysqli_query($koneksi,$cek_B0039);
	  $r_B0039=mysqli_fetch_array($da_B0039);
	  
	  if($r_B0039['kunci']=='1')
	  {
		$warna="7bf360";
	  }elseif($r_B0039['kunci']=='0')
	  {
		$warna="fd8888";
	  }
	  else
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;"><?=$data_bid_b_b0039['kum_usulan_lama'];?></td>
	<td style="vertical-align: middle;"><?=$data_bid_b_b0039['kum_usulan_baru']?></td>
	<td style="vertical-align: middle;"><?= $jumlah_b0039 ;?></td>
	<td style="vertical-align: middle;"><?=$data_bid_b_b0039['kum_penilai_lama']?></td>
	<td style="vertical-align: middle;"><?=$data_bid_b_b0039['kum_penilai_baru']?></td>
	<td style="vertical-align: middle;"><?=$kum_nilai_b0039?></td>
	<td style="vertical-align: middle;">
			
		<a href="<?= base_url()?>penilai/penilai_dupak_b/dupak/B0039/<?php echo $no; ?>" class="btn btn-circle btn-info waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
  ...
  <tr bgcolor="<?=$warna?>">
	...
	<td style="vertical-align: middle;">
		<a title="Validasi Angka Kredit" href="#" data-toggle="modal" data-target="#tambah"  class="btn btn-circle btn-success waves-effect waves-light m-t-20"><i class="fa fa-search"></i></a>
	</td>
  </tr>
...
<!-- Modal Tambah-->
<?php
$dta_b0040=mysqli_query($koneksi,"select *from usulan_dupaks where dupak_no='B0040' and usulan_no='$no'");
$isi_b0040=mysqli_fetch_array($dta_b0040);
$jmlah_b0040=$isi_b0040['kum_usulan_lama']+$isi_b0040['kum_usulan_baru'];
$kum_pen_b0040=$isi_b0040['kum_penilai_lama']+$isi_b0040['kum_penilai_baru'];
?>
<form method="post" action="<?= base_url()?>penilai/penilai_dupak_b/update_B0040/B0040/<?=$no; ?>" role="form" enctype="multipart/form-data">

<div class="modal fade"  aria-labelledby="myModalLabel" id="tambah" >
	<div class="modal-dialog">
		<div class="modal-content">
		<div class="modal-header">
		<h4>Validasi Sisa Angka Kredit pada Jabatan Sebelumnya (AK x 40%)</h4>
		</div>
		<div class="modal-body">
			<div class="row">
			  <div class="col-md-10">
				<div class="form-group">
				  <label>Usulan Sisa Angka Kredit (AK x 40%) :</label><br>
					<input type="text" name="ak_usulan" value="<?=$jmlah_b0040?>" style="width:100px;" class="form-control" id="ak_usulan" readonly>
				</div>
			  </div>
			  <div class="col-md-10">
				<div class="form-group">
				  <label>Angka Kredit Penilaian :</label><br>
				  <?php
				  if($kum_pen_b0040=='0' || $kum_pen_b0040=='')
				  {
					  $nilai_ak_pen=$jmlah_b0040;
				  }else
				  {
					  $nilai_ak_pen=$kum_pen_b0040;
				  }
				  ?>
					<input type="text" name="ak_penilai"  value="<?=$nilai_ak_pen?>" style="width:90px;" class="form-control"  required><br>
			...
			<?php
			$da_ceklis=mysqli_query($koneksi,"select sk_jad_dosen from usulan_ceklists where usulan_no='$no'");
			$isi_ceklis=mysqli_fetch_array($da_ceklis);
			?>
			<div class="row">
			  <div class="col-md-12">
				<div class="form-group">
				  <label>Fotocopy PAK dan SK Jabatan Akademik Dosen :</label><br>
				  <?php
				  if($isi_ceklis['sk_jad_dosen']=='')
				  {
				  ?>
					<a href="#" class="btn btn-md btn-danger"><i class="fa fa-ban"> [File Belum Diupload]</i></a>
				  <?php
				  }else
				  {
				  ?>
					<a href="<?= base_url()?>penilai/penilai_dupak_b/download_sk_jad_dosen/<?= $isi_ceklis['sk_jad_dosen'] ?>" target="_blank" class="btn btn-md btn-info"><i class="fa fa-search"> [Lihat File]</i></a>
				  <?php
				  }
				  ?>
			  ...
			  <div class="col-md-12">
				<div class="form-group">
				  <label>Keterangan</label><br>
					<textarea name="kum_penilai_keterangan" class="form-control" id="keterangan" rows="5"><?=$kum_penilai_keterangan?></textarea>
				</div>
			  </div>
			</div>
		</div>
