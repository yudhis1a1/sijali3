            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    if ($usulan_jabatan == '8' || $usulan_jabatan == '11' || $usulan_jabatan == '12' || $usulan_jabatan == '9' || $usulan_jabatan == '10' || $usulan_jabatan == '13') {
                        if ($selisih < '8') {
                    ?>
                            <li class="nav-item"> <a class="nav-link" href="<?= base_url() ?>penilai/penilai/bidangE/<?php echo $data_dasar->no; ?>"><span class="hidden-sm-up"><i class="ti-agenda "></i></span> <span class="hidden-xs-down">Tambahan LK/GB</span></a> </li>
                        <?php
                        }
                            ...
                            <div class="card-body">
                                <form class="form">
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group m-t-40 row">
                                            <label for="example-text-input" class="col-2 col-form-label">Pendidikan pada Jabatan Sebelumnya</label>
                                            <div class="col-10">
                                                <input class="form-control" type="text" name="jabatan_usulan_no" value="<?= $jenjang_lama_id; ?>" readonly>
                                            </div>
                                        </div>
                                    <?php
                                    }
                                    ?>
                                    <div class="form-group m-t-40 row">
                                        <label for="example-text-input" class="col-2 col-form-label">Pendidikan pada Usulan Kenaikan Jabatan </label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" id="jenjang_id" value="<?= $data_dasar->nama_jenjang; ?> " readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group m-t-40 row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="jabatan_usulan_no" value="<?= $jad_usulan; ?>" readonly>
                                        </div>
                                    </div>
                                </form>
                            </div>
